...
Issues #85, #103, #137, #167, #169, #171, #173, #175, #177, #183, #189, #191, #197, #199, #201, #203, #205, #207, #209, #211, #253, #259, #347, #351, #354, #358, #360, #362, #364, #366, #368, #370, #372, #374, #376, #378, #380, and #420 add the first audience automation
...
post-MVP execution bucket for owner-only sequence and broadcast test-send paths, live
sender/provider setup, Queue producer and consumer execution, recipient payloads, provider calls, delivery results,
...
- `/api/admin/audience/sequences/test-sends`: owner-gated GET/POST endpoint
  that sends the seeded sequence step preview only to the verified owner session
  email and records redacted provider evidence.
...
- `/api/admin/audience/broadcasts/test-sends`: owner-gated GET/POST endpoint
  that sends the seeded broadcast preview only to the verified owner session
  email and records redacted provider evidence.
