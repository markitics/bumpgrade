...
- `features/analytics-experiments.md`: event, metric, aggregate conversion
  ...
  assignment contract, owner-confirmed experiment decision evidence, and
  aggregate report export metadata from issues #87, #105, #107, #119, #121,
  #123, #125, #127, #129, #261, and #263, including fixed all-time, 24-hour,
  7-day, and 30-day aggregate source/conversion windows.
