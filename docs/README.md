...
- `features/audience-automation.md`: opt-in, lead magnet, tag, sequence,
  ...
  Queue consumer readiness, sequence Queue producer readiness, owner-confirmed import intent, owner-confirmed import preflight,
  ...
  dry-run sequence dispatch attempt evidence, and sequence Queue producer readiness evidence
  contracts from issues #85, #103, #137, #167, #169, #171, #173, #175, #177,
  #183, #189, #191, #197, #199, #201, #203, #205, #207, #209, #211, and
  #253, #259, #347, #351, #354, #358, #360, #362, #364, and #366.
