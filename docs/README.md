...
- `features/analytics-experiments.md`: event, metric, aggregate conversion
  ...
  report export metadata, and owner-reviewed cohort comparison evidence from
  issues #87, #105, #107, #119, #121, #123, #125, #127, #129, #261, #263, and
  #265, including fixed all-time, 24-hour, 7-day, and 30-day aggregate
