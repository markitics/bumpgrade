...
- `features/mobile-admin.md`: iOS and Android publisher/admin app planning,
  ...
  owner-session-only `/api/mobile-admin/private-rows` route, the owner-confirmed
  low-risk `/api/mobile-admin/private-rows/actions` route, and the owner-gated
  audit-only `/api/mobile-admin/actions` intent route.
