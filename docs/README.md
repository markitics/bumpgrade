...
- `features/analytics-experiments.md`: event, metric, aggregate conversion
  ...
  content/consent readiness, send-payload readiness, and queue-producer readiness from issues #87, #105, #107, #119,
  #121, #123, #125, #127, #129, #261, #263, #265, #267, #269, #271, #284, #286, #288, #290, and #292, including
