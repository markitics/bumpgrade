...
delivery-attempt readiness, delivery-result readiness, and delivery-status
webhook readiness
evidence.
...
checks, and sample-size caveat acknowledgement. The
...
delivery-status-webhook readiness evidence, plus aggregate
