...
a fresh revision check, link resource/delivery blocks to product access assets
...
linking, and archive/unpublish lifecycle actions are owner-confirmed; physical
deletion, drag-and-drop block editing, arbitrary private R2 delivery, signed URL
