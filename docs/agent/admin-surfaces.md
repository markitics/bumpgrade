...
delivery readiness evidence, plus content/consent readiness and send-payload
readiness evidence for agents.
...
evidence, and write boundaries. Experiment
...
readiness records, content/consent readiness records, and send-payload
...
customers, create queue messages, create recipient payloads, create
