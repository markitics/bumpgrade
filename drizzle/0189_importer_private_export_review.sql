...
SET
  public_evidence_json = json_array(
    ...
    '/imports/source-data exposes platform IDs, input kinds, platform-specific source checklists, export match templates, preflight signal labels, export-file parser fields, importReview persistence fields, saved private plan parts, preflight review routes, private-draft API routes, rollback routes, safety gates, limitations, and source evidence IDs for agents.',
  ...
  next_milestone = 'Deepen private draft export review into structured draft extraction, then add subscriber import depth behind explicit confirmed-write gates.',
...
INSERT INTO admin_work_log_entries (
  ...
  'work-log-2026-05-25-importer-private-export-review',
  'Persisted private importer export review metadata',
  'Codex',
  'codex',
  ...
  json_array('Focused private importer export review metadata and redaction smoke coverage', 'typecheck', 'lint', 'runtime secrets', 'Cloudflare build'),
  NULL,
  unixepoch() - 1800,
  unixepoch(),
  json_array('https://bumpgrade.com/imports/source-data', 'https://bumpgrade.com/imports/samcart', 'https://bumpgrade.com/pr-screenshots/issue-467-private-export-review.png', 'https://bumpgrade.com/admin/work-log'),
  NULL,
  unixepoch()
)
