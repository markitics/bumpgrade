...
INSERT INTO admin_work_log_entries (
  ...
  json_array(json_object('number', 526, 'url', 'https://github.com/markitics/bumpgrade/pull/526')),
  ...
  json_array('Focused private SamCart importer checkout-readiness and redaction smoke coverage', 'Typecheck', 'Lint', 'Runtime secrets', 'Cloudflare build', 'PR #526 CI passed static checks and browser journeys.'),
  ...
  unixepoch('2026-05-26T21:20:00Z'),
  json_array('https://bumpgrade.com/imports/source-data', 'https://bumpgrade.com/imports/samcart/review', 'https://bumpgrade.com/pr-screenshots/issue-467-checkout-readiness.png', 'https://bumpgrade.com/admin/work-log'),
  'https://github.com/markitics/bumpgrade/pull/526',
  unixepoch()
)
