...
SET
  public_evidence_json = json_insert(
    ...
    '$[#]',
    json_object(
      'label', 'Issue #265 owner-reviewed analytics cohort comparison evidence',
      'url', 'https://github.com/markitics/bumpgrade/issues/265'
    )
  ),
...
INSERT INTO admin_work_log_entries (
  ...
  'work-log-2026-05-21-analytics-cohort-comparison-evidence',
  'Added owner-reviewed analytics cohort comparison evidence',
  'Codex',
  'codex',
  'bumpgrade-bootstrap',
  ...
  '["src/lib/analytics-report-exports.ts","src/app/analytics/source-data/route.ts","src/lib/agent-manifest.ts","docs/features/analytics-experiments.md","drizzle/0098_analytics_cohort_comparison_evidence.sql"]',
