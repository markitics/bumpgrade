...
SET
  public_evidence_json = json_array(
    ...
    '/imports/source-data exposes platform IDs, input kinds, platform-specific source checklists, export match templates, preflight signal labels, export-file parser fields, private structured import-record fields, extracted field plans, subscriber import depth, private record review routes, review-action routes, extracted-field edit actions, saved private plan parts, preflight review routes, private-draft API routes, safety gates, limitations, and source evidence IDs for agents.',
  ...
  next_milestone = 'Add confirmed subscriber import preflight records that reuse the safe importer audience review without creating live subscribers or sends.',
