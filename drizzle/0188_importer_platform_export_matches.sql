...
SET
  public_evidence_json = json_array(
    ...
    '/imports/source-data exposes platform IDs, input kinds, platform-specific source checklists, export match templates, preflight signal labels, export-file parser fields, saved private plan parts, preflight review routes, private-draft API routes, rollback routes, safety gates, limitations, and source evidence IDs for agents.',
  ...
  next_milestone = 'Use platform export matches to deepen draft extraction, then add subscriber import depth behind explicit confirmed-write gates.',
...
INSERT INTO admin_work_log_entries (
  ...
  'work-log-2026-05-25-importer-platform-export-matches',
  'Added platform-specific importer export matching',
  'Codex',
  'codex',
  ...
  json_array('Focused importer platform export match and redaction smoke coverage', 'typecheck', 'lint', 'runtime secrets', 'Cloudflare build'),
  NULL,
  unixepoch() - 1800,
  unixepoch(),
