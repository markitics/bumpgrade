...
INSERT INTO admin_work_log_entries (
  ...
  'work-log-2026-05-25-agent-funnel-public-publishing',
  'Added owner-session agent funnel publishing',
  'Codex',
  'codex',
  'bumpgrade-agent-funnel-publishing',
  ...
  '["docs/features/funnels.md","docs/agent/agent-ready.md","public/llms.txt","docs/pr-screenshots/issue-417-agent-funnel-publishing.png"]',
