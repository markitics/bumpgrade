CREATE TABLE IF NOT EXISTS analytics_notification_delivery_attempt_readiness_records (
  id TEXT PRIMARY KEY,
  ...
  notification_delivery_attempt_readiness_disposition TEXT NOT NULL,
  ...
  expected_notification_provider_call_readiness_status TEXT NOT NULL,
  ...
  owner_delivery_attempt_readiness_recorded INTEGER NOT NULL DEFAULT 0,
...
CREATE UNIQUE INDEX IF NOT EXISTS analytics_notification_delivery_attempt_readiness_idempotency_unique
  ON analytics_notification_delivery_attempt_readiness_records(idempotency_key);
CREATE INDEX IF NOT EXISTS analytics_notification_delivery_attempt_readiness_dashboard_time_idx
  ON analytics_notification_delivery_attempt_readiness_records(dashboard_id, created_at);
CREATE INDEX IF NOT EXISTS analytics_notification_delivery_attempt_readiness_readiness_channel_idx
  ON analytics_notification_delivery_attempt_readiness_records(readiness_id, channel_id, created_at);
CREATE INDEX IF NOT EXISTS analytics_notification_delivery_attempt_readiness_send_payload_idx
  ON analytics_notification_delivery_attempt_readiness_records(send_payload_readiness_id, created_at);
CREATE INDEX IF NOT EXISTS analytics_notification_delivery_attempt_readiness_provider_call_idx
  ON analytics_notification_delivery_attempt_readiness_records(provider_call_readiness_id, created_at);
...
INSERT INTO admin_work_log_entries (
  ...
  'work-log-2026-05-21-analytics-notification-delivery-attempt-readiness',
  'Added analytics notification delivery-attempt readiness records',
  'Codex',
  'codex',
  'bumpgrade-bootstrap',
