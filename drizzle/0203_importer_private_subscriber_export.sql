...
SET
  ...
  next_milestone = 'Keep sequence enrollment and sends, checkout/payment credential migration, account transfer, domains, and fulfillment parked behind dedicated confirmed-write work; use the importer surface for private migration planning, audience review cleanup, and owner-only contact export until those gates ship.',
...
INSERT INTO admin_work_log_entries (
  ...
  'work-log-2026-05-26-importer-private-subscriber-export',
  'Added owner-only private subscriber CSV export for importers',
  'Codex',
  'codex',
  ...
  json_array('Focused private Kit importer subscriber export and redaction smoke coverage', 'typecheck', 'lint', 'runtime secrets', 'Cloudflare build'),
  ...
  unixepoch() - 1800,
  unixepoch(),
  json_array('https://bumpgrade.com/imports/source-data', 'https://bumpgrade.com/imports/kit/review', 'https://bumpgrade.com/pr-screenshots/issue-467-private-subscriber-export.png', 'https://bumpgrade.com/admin/work-log'),
  NULL,
  unixepoch()
)
