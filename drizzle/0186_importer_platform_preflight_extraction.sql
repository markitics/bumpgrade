...
SET
  public_evidence_json = json_array(
    ...
    '/imports/source-data exposes platform IDs, input kinds, platform-specific source checklists, preflight signal labels, saved private plan parts, preflight review routes, private-draft API routes, rollback routes, safety gates, limitations, and source evidence IDs for agents.',
  ...
  next_milestone = 'Add real export parsing after platform-specific preflight extraction, shared private drafts, duplicate review, and rollback/restart paths are stable.',
...
SET
  happy_path_json = json_array(
    ...
    'Use /imports/source-data when an agent needs stable importer IDs, input kinds, source checklist items, preflight signal labels, saved private plan parts, safety gates, limitations, source IDs, private import API routes, and rollback routes.'
  ),
  ...
  agent_access = 'Agents can read /imports/source-data, /compare/source-data, and /features/source-data to answer importer questions with platform IDs, input kinds, platform-specific source checklists, source checklist items, preflight signal labels, redacted sourceChecklistReview maps, duplicate-review fields, saved private plan parts, rollback routes, safety gates, source IDs, limitations, and private import API routes. Creating or archiving a private import plan requires verified publisher auth, exact confirmation, idempotency, audit evidence, and redacted responses; public or billing-impacting import writes remain unavailable.',
  validation_json = json_array(
    'Issue #467 adds /imports, dedicated importer source guides, /imports/clickfunnels, /imports/source-data, public redacted preflight review, sourceChecklistReview maps, sitemap and llms discovery, feature and comparison source-data references, and importer smoke coverage.',
...
INSERT INTO admin_work_log_entries (
  ...
  'work-log-2026-05-25-importer-platform-preflight-extraction',
  'Added platform-specific importer preflight extraction',
  'Codex',
  'codex',
  ...
  json_array('Focused importer preflight/source-data and dedicated route smoke coverage', 'typecheck', 'lint', 'runtime secrets', 'Cloudflare build'),
  NULL,
  unixepoch() - 1800,
  unixepoch(),
