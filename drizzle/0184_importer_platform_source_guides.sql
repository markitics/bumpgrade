...
SET
  public_evidence_json = json_array(
    ...
    '/imports/source-data exposes platform IDs, input kinds, platform-specific source checklists, saved private plan parts, preflight review routes, private-draft API routes, rollback routes, safety gates, limitations, and source evidence IDs for agents.',
...
SET
  ...
  agent_access = 'Agents can read /imports/source-data, /compare/source-data, and /features/source-data to answer importer questions with platform IDs, input kinds, platform-specific source checklists, redacted preflight review routes, duplicate-review fields, saved private plan parts, rollback routes, safety gates, source IDs, limitations, and private import API routes. Creating or archiving a private import plan requires verified publisher auth, exact confirmation, idempotency, audit evidence, and redacted responses; public or billing-impacting import writes remain unavailable.',
...
INSERT INTO admin_work_log_entries (
  ...
  'work-log-2026-05-25-importer-platform-source-guides',
  'Added platform-specific importer source guides',
  'Codex',
  'codex',
  ...
  json_array('Focused importer source-data and dedicated route smoke coverage', 'typecheck', 'lint', 'runtime secrets', 'Cloudflare build'),
  NULL,
  unixepoch() - 1800,
  unixepoch(),
