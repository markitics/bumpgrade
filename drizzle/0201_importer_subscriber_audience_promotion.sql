...
SET
  summary = 'Importer center, dedicated platform import paths, public redacted review maps, private draft creation, private subscriber import records, owner-only private subscriber inspection, imported-pending audience review-list promotion, and reusable source-data contract for moving competitor platform context into private Bumpgrade launch workspaces before go-live.',
  ...
  next_milestone = 'Keep sequence enrollment and sends, private exports, checkout/payment credential migration, account transfer, domains, and fulfillment parked behind dedicated confirmed-write work; use the importer surface for private migration planning and audience review cleanup until those gates ship.',
...
INSERT INTO admin_work_log_entries (
  ...
  'work-log-2026-05-26-importer-subscriber-audience-promotion',
  'Added importer subscriber audience review-list promotion',
  'Codex',
  'codex',
  ...
  json_array(),
  json_array('https://bumpgrade.com/imports', 'https://bumpgrade.com/imports/source-data', 'https://bumpgrade.com/imports/kit/review', 'https://bumpgrade.com/audience/source-data'),
  ...
  json_array('Focused private Kit importer subscriber audience-promotion and redaction smoke coverage', 'typecheck', 'lint', 'runtime secrets', 'Cloudflare build'),
  ...
  unixepoch() - 1800,
  unixepoch(),
  json_array('https://bumpgrade.com/imports/source-data', 'https://bumpgrade.com/audience/source-data', 'https://bumpgrade.com/imports/kit/review', 'https://bumpgrade.com/pr-screenshots/issue-467-subscriber-audience-promotion.png', 'https://bumpgrade.com/admin/work-log'),
  NULL,
  unixepoch()
)
