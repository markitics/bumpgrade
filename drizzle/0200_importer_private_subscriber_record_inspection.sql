...
SET
  summary = 'Importer center, dedicated platform import paths, public redacted review maps, private draft creation, private subscriber import records, owner-only private subscriber inspection, and reusable source-data contract for moving competitor platform context into private Bumpgrade launch workspaces before go-live.',
  public_evidence_json = json_array(
    ...
    '`/imports/source-data` exposes platform IDs, input kinds, platform-specific source checklists, export match templates, preflight signal labels, export-file parser fields, private structured import-record fields, extracted field plans, subscriber import depth, subscriber import preflight actions, subscriber import creation actions, owner-only private subscriber record inspection rules, private record review routes, review-action routes, extracted-field edit actions, saved private plan parts, preflight review routes, private-draft API routes, safety gates, limitations, and source evidence IDs for agents.',
...
SET
  happy_path_json = json_array(
    ...
    'Use /imports/source-data when an agent needs stable importer IDs, input kinds, source checklist items, export match templates, preflight signal labels, export-file parser fields, importReview persistence fields, structured private import-record fields, extracted field plans, subscriber import depth, subscriber import preflight actions, subscriber import creation actions, owner-only private subscriber record inspection rules, private record review routes, review action routes, extracted-field edit actions, saved private plan parts, safety gates, limitations, source IDs, private import API routes, and rollback routes.'
  ),
...
INSERT INTO admin_work_log_entries (
  ...
  'work-log-2026-05-26-importer-subscriber-record-inspection',
  'Added owner-only private subscriber record inspection to importer review',
  'Codex',
  'codex',
  ...
  json_array('Focused private Kit audience importer subscriber-inspection and redaction smoke coverage', 'typecheck', 'lint', 'runtime secrets', 'Cloudflare build'),
  'Owner-only review can inspect saved private importer contacts; public source-data, unauthenticated responses, global audience send-list import, sequence enrollment, sends, private exports, and go-live effects remain gated.',
  unixepoch() - 1800,
  unixepoch(),
  json_array('https://bumpgrade.com/imports/source-data', 'https://bumpgrade.com/imports/kit/review', 'https://bumpgrade.com/pr-screenshots/issue-467-subscriber-record-inspection.png', 'https://bumpgrade.com/admin/work-log'),
  NULL,
  unixepoch()
)
