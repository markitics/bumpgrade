import {
  ...
  audienceBroadcastSendPayloadReadinessUpdatedAt,
...
export const audienceAutomationUpdatedAt = audienceBroadcastSendPayloadReadinessUpdatedAt;
  ...
  broadcastDrafts: [
    {
      ...
      approvalBoundary:
        "Issue #207 can inspect send-payload readiness for this draft, but real sending still requires verified sender alignment, provider event handling, provider rate-limit handling, provider response handling, queue producers/consumers, and audit correlation.",
    },
  ],
