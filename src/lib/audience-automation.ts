...
export const audienceAutomationUpdatedAt = "2026-05-22";
...
export const audienceAutomationWorkspace: AudienceAutomationWorkspace = {
  ...
  validation: [
    ...
    "/audience/source-data exposes aggregate sequence delivery readiness without recipient payloads, body templates, unsubscribe URLs, Queue payloads, provider IDs, or send/export URLs.",
