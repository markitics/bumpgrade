...
import {
  ...
  audienceSequenceDeliveryReceiptReadinessStatus,
...
export type AudienceAutomationWorkspace = {
  ...
  sequenceDispatchAttemptApiRoute: "/api/admin/audience/sequences/dispatch-attempts";
  sequenceQueueProducerReadinessApiRoute: "/api/admin/audience/sequences/queue-producer-readiness";
  sequenceQueueConsumerReadinessApiRoute: "/api/admin/audience/sequences/queue-consumer-readiness";
  sequenceProviderCallReadinessApiRoute: "/api/admin/audience/sequences/provider-call-readiness";
  sequenceDeliveryAttemptReadinessApiRoute: "/api/admin/audience/sequences/delivery-attempt-readiness";
  sequenceDeliveryResultReadinessApiRoute: "/api/admin/audience/sequences/delivery-result-readiness";
  ...
  sequenceDeliveryReceiptReadinessApiRoute: typeof audienceSequenceDeliveryReceiptReadinessApiRoute;
...
export const audienceAutomationWorkspace: AudienceAutomationWorkspace = {
  ...
  sequenceDeliveryReceiptReadinessApiRoute: audienceSequenceDeliveryReceiptReadinessApiRoute,
  ...
  validation: [
    ...
    "/api/admin/audience/sequences/dispatch-attempts stores owner-confirmed dry-run sequence dispatch attempt receipts without Cloudflare Queue dispatch, queue payload bodies, delivery queue rows, recipient payloads, personalized bodies, unsubscribe URLs, provider sends, provider responses, or provider message IDs.",
    ...
    "Provider-call readiness records expose provider mode, Queue consumer dependency, provider response, message-ID, delivery-attempt, idempotency, audit, and backpressure gates without making provider calls, sending messages, creating delivery attempts or results, provider responses, provider message IDs, webhooks, receipts, recipient payloads, personalized bodies, or unsubscribe URLs.",
    "/api/admin/audience/sequences/delivery-attempt-readiness stores owner-reviewed sequence delivery-attempt readiness without making provider calls, sending messages, creating provider responses or message IDs, creating delivery attempts or results, processing webhooks, creating receipts, consuming or acking Queue messages, reading queue payload bodies, creating recipient payloads, personalized bodies, or unsubscribe URLs.",
    "/api/admin/audience/sequences/delivery-result-readiness stores owner-reviewed sequence delivery-result readiness without making provider calls, sending messages, creating provider responses or message IDs, creating delivery attempts or results, processing webhooks, creating receipts, consuming or acking Queue messages, reading queue payload bodies, creating recipient payloads, personalized bodies, or unsubscribe URLs.",
    "/api/admin/audience/sequences/delivery-status-webhook-readiness stores owner-reviewed sequence delivery-status webhook readiness without making provider calls, sending messages, creating provider responses or message IDs, creating delivery attempts or results, processing status webhooks, reading webhook payloads, polling providers, creating receipt payloads or receipts, consuming or acking Queue messages, reading queue payload bodies, creating recipient payloads, personalized bodies, or unsubscribe URLs.",
    "/api/admin/audience/sequences/provider-polling-readiness stores owner-reviewed sequence provider-polling readiness without making provider calls, sending messages, creating provider responses or message IDs, creating delivery attempts or results, processing status webhooks, reading webhook or polling payloads, polling providers, creating polling results, receipt payloads, receipts, recipient payloads, personalized bodies, or unsubscribe URLs.",
    "/api/admin/audience/sequences/receipt-payload-readiness stores owner-reviewed sequence receipt-payload readiness without making provider calls, sending messages, creating provider responses or message IDs, creating delivery attempts or results, processing status webhooks, polling providers, creating polling results, receipt payloads, delivery receipts, recipient payloads, personalized bodies, or unsubscribe URLs.",
    "/api/admin/audience/sequences/delivery-receipt-readiness stores owner-reviewed sequence delivery-receipt readiness without making provider calls, sending messages, creating provider responses or message IDs, creating delivery attempts or results, processing status webhooks, polling providers, reading receipt payloads, creating delivery receipts, creating recipient payloads, personalized bodies, or unsubscribe URLs.",
...
export const audienceAutomationSourceData = {
  ...
  routes: [
    ...
    "/api/admin/audience/sequences/dispatch-attempts",
