...
export const audienceAutomationWorkspace: AudienceAutomationWorkspace = {
  ...
  validation: [
    ...
    "/api/admin/audience/sequences/delivery-receipt-readiness stores owner-reviewed sequence delivery-receipt readiness without making provider calls, sending messages, creating provider responses or message IDs, creating delivery attempts or results, processing status webhooks, polling providers, reading receipt payloads, creating delivery receipts, recipient payloads, personalized bodies, or unsubscribe URLs.",
