...
export const roadmapItems: RoadmapItem[] = [
  ...
  },
  {
    ...
    publicEvidence: [
      ...
      "Issue #383 adds owner-reviewed sequence delivery-receipt readiness gates without making provider calls, sending messages, creating provider responses or message IDs, creating delivery attempts or results, processing status webhooks, reading webhook, polling, or receipt payloads, polling providers, creating polling results, delivery receipts, receipts, consuming or acking Queue messages, reading queue payload bodies, creating recipient payloads, personalized bodies, or unsubscribe URLs.",
      "Codex project email in issue #10 is separate from publisher/customer email workflows.",
    ],
    nextMilestone:
      "Add real contact imports, sequence scheduling, Cloudflare Queue producers, consumers, provider calls, delivery attempts, delivery results, status webhooks, provider polling, receipt payloads, delivery receipts, and status reconciliation only after sender-domain, provider-event, provider rate-limit, provider response, send-payload, Queue producer, Queue consumer, provider-call, delivery-attempt, delivery-result, delivery-status webhook, provider-polling, receipt-payload, delivery-receipt, import redaction, unsubscribe footer, suppression, audit checks, sequence delivery-readiness, sequence delivery-batch gates, sequence queue-message gates, sequence dispatch-preflight gates, sequence dispatch-attempt receipts, sequence Queue producer readiness, sequence Queue consumer readiness, sequence provider-call readiness, sequence delivery-attempt readiness, sequence delivery-result readiness, sequence delivery-status webhook readiness, sequence provider-polling readiness, sequence receipt-payload readiness, sequence delivery-receipt readiness, delivery-batch gates, queue-message gates, dispatch preflight boundaries, and dispatch-attempt receipts stay explicit.",
  },
  {
