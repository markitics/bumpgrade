...
export const roadmapItems: RoadmapItem[] = [
  ...
  },
  {
    ...
    publicEvidence: [
      ...
      "Issue #417 adds owner-confirmed checkout unlinking, owner-confirmed resource delivery links, funnel-scoped private download-token delivery from published linked resource blocks, owner-session agent-created resource delivery tokens for published linked resource blocks, owner-confirmed webinar event/replay links, owner-session visual block style controls, owner-session bounded canvas layout controls, owner-confirmed archived-draft purge with tombstone evidence, owner-session within-step block reordering, owner-session drag/drop block placement through existing move endpoints, owner-session cross-step block moves, and owner-session direct agent-safe draft writes for block copy edits, visual style presets, bounded canvas layouts, reusable block add/remove, checkout linking/unlinking, resource-delivery linking, webinar-event linking, block movement, duplication, public publishing, archive/unpublish, and archived-draft purge while tracking remaining full webinar integrations, bulk purge policy, live fulfillment automation, arbitrary uploaded private asset delivery, unauthenticated public agent-created delivery tokens, and unauthenticated public agent publishing after the MVP closeout.",
    ],
    nextMilestone:
      "Keep arbitrary uploaded private asset delivery, live fulfillment automation, full webinar integrations, bulk purge policy, unauthenticated public agent-created delivery tokens, and unauthenticated public agent publishing in issue #417; keep live publisher-offer billing in issue #219.",
  },
  {
    ...
    nextMilestone:
      "Design arbitrary uploaded private asset delivery, live fulfillment automation, full webinar integrations, bulk purge policy, unauthenticated public agent-created delivery tokens, and unauthenticated public agent publishing as one coherent post-MVP workflow instead of more single-gate readiness slices.",
  },
  {
  ...
  },
  {
    ...
    group: "Growth system",
    summary:
      "Affiliate/referral MVP contract, partner profiles, referral links, privacy-safe click capture, checkout attribution evidence, review-only commission ledger evidence, owner review/reversal actions, public-safe partner reports, public-safe partner portal status pages, public-safe partner statement snapshots, read-only payout preparation, owner-confirmed payout preparation records, owner-reviewed fraud review records, owner-reviewed partner notification readiness records, owner-reviewed partner notification send preflight records, owner-reviewed notification provider readiness records, attribution boundaries, payout review, and fraud review proof.",
    publicEvidence: [
      "Tracked by issue #19.",
    ...
    nextMilestone:
      "Keep payable statements, payable commissions, Stripe payout execution, partner notification sends, provider configuration, private payout/tax data, authenticated private partner portals, and agent-safe write tools in issue #424 instead of reopening more isolated readiness-gate slices.",
  },
  {
