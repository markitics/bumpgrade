...
export const roadmapItems: RoadmapItem[] = [
  ...
  },
  {
    ...
    nextMilestone:
      "Design freeform canvas layout styling, arbitrary uploaded private asset delivery, live fulfillment automation, full webinar integrations, bulk purge policy, direct agent-created delivery tokens, and direct agent-safe write tools as one coherent post-MVP workflow instead of more single-gate readiness slices.",
  },
  {
