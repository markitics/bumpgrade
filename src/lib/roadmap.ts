...
export const roadmapItems: RoadmapItem[] = [
  ...
  },
  {
    ...
    publicEvidence: [
      ...
      "`/mobile-admin/dashboard/source-data` exposes the public-safe dashboard digest plus the redacted Director workstream brief and redacted private-row, private-row action, and action-intent summaries for mobile clients.",
