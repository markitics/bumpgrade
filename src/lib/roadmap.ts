...
export const roadmapItems: RoadmapItem[] = [
  ...
  },
  {
    ...
    group: "Mobile",
    summary:
      "Current follow-up for installable private mobile admin parity after the completed read-only dashboard, iOS scaffold, Android scaffold, live-hydration, owner-session/confirmed-action contract, owner-gated private-row inspection, low-risk private-row workflow actions, and owner-gated audit-only action-intent API slices.",
    publicEvidence: [
      ...
      "`/mobile-admin/dashboard/source-data` exposes the public-safe dashboard digest plus redacted private-row, private-row action, and action-intent summaries for mobile clients.",
      "`/mobile-admin/ios/source-data` exposes the iOS scaffold, fixture, simulator smoke command, owner-session contract, private-row API panel, private-row action API panel, action-intent API panel, confirmed-action cards, and screenshot path.",
      "`/mobile-admin/android/source-data` exposes the Android scaffold, fixture asset, emulator smoke command, owner-session contract, private-row API panel, private-row action API panel, action-intent API panel, confirmed-action cards, and screenshot path.",
    ],
    nextMilestone:
      "Add higher-risk domain-specific production confirmed-write APIs, device proof, push-notification boundaries, and eventual distribution readiness without claiming App Store or Play Store parity early.",
  },
  {
    id: "roadmap-funnels",
    ...
    summary:
      "Multi-step funnel model, source-data contract, read-only seeded preview scaffold, owner-gated editable draft scaffold with step edit/reorder controls, granular block title/body editing, reusable block add/remove controls, owner-session within-step block reordering, owner-gated private preview, exact-confirmed public publishing, reusable template and block-template library records including webinar/resource page shapes, owner-confirmed template-to-draft creation, owner-confirmed private draft duplication, owner-confirmed checkout-offer linking on private draft steps, public sandbox checkout start rendering from published linked checkout blocks, owner-confirmed archive/unpublish lifecycle actions, owner-confirmed resource delivery links to product/access catalog assets, and safe draft proposals.",
    publicEvidence: [
      "Tracked by issue #14.",
      ...
      "Issue #417 adds owner-confirmed checkout unlinking, owner-confirmed resource delivery links, and owner-session within-step block reordering while tracking remaining freeform drag-and-drop editing, webinar integrations, physical deletion policy, live fulfillment automation, and direct agent-safe write tools after the MVP closeout.",
    ],
    nextMilestone:
      "Keep freeform drag-and-drop canvas editing, arbitrary private R2 delivery, live fulfillment automation, live webinar integrations, physical deletion policy, and direct agent-safe funnel tools in issue #417; keep live publisher-offer billing in issue #219.",
  },
  {
    ...
    group: "Funnels and pages",
    summary:
      "Active post-MVP funnel parity for freeform drag-and-drop visual editing, resource delivery, webinar integrations, physical deletion policy, and direct agent-safe write tools; owner-confirmed checkout unlinking, resource delivery links, and within-step block reordering are now part of this bucket's shipped evidence.",
    publicEvidence: [
    ...
    nextMilestone:
      "Design freeform drag-and-drop canvas editing, arbitrary private R2 delivery, live fulfillment automation, live webinar integrations, physical deletion, and direct agent-safe write tools as one coherent post-MVP workflow instead of more single-gate readiness slices.",
  },
  {
