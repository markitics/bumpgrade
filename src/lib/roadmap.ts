...
export const roadmapItems: RoadmapItem[] = [
  ...
  },
  {
    ...
    publicEvidence: [
      ...
      "`/imports/source-data` exposes platform IDs, input kinds, platform-specific source checklists, export match templates, preflight signal labels, export-file parser fields, private structured import-record fields, private record review routes, review-action routes, saved private plan parts, preflight review routes, private-draft API routes, safety gates, limitations, and source evidence IDs for agents.",
    ...
    nextMilestone:
      "Use importer record review decisions to drive deeper field extraction and editing, then add subscriber import depth behind explicit confirmed-write gates.",
  },
  {
