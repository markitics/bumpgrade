...
export const roadmapItems: RoadmapItem[] = [
  ...
  },
  {
    ...
    publicEvidence: [
      ...
      "Issue #417 adds owner-confirmed checkout unlinking, owner-confirmed resource delivery links, funnel-scoped private download-token delivery from published linked resource blocks, owner-confirmed webinar event/replay links, owner-confirmed archived-draft purge with tombstone evidence, owner-session within-step block reordering, owner-session drag/drop block placement through existing move endpoints, owner-session cross-step block moves, and owner-session direct agent-safe private draft writes for block copy edits, duplication, and archive/unpublish while tracking remaining freeform canvas styling, full webinar integrations, bulk purge policy, live fulfillment automation, arbitrary uploaded private asset delivery, direct agent-created delivery tokens, direct agent public publishing, direct agent checkout/resource/webinar linking, and direct agent purge after the MVP closeout.",
    ],
    nextMilestone:
      "Keep freeform canvas layout styling, arbitrary uploaded private asset delivery, live fulfillment automation, full webinar integrations, bulk purge policy, direct agent-created delivery tokens, direct agent public publishing, direct agent checkout/resource/webinar linking, and direct agent purge in issue #417; keep live publisher-offer billing in issue #219.",
  },
  {
    ...
    publicEvidence: [
      ...
      "Issue #417 adds owner-session direct agent-safe private draft writes through /api/agent/funnels/draft-writes for block copy edits, private duplication, and archive/unpublish after exact confirmation, idempotency, current revision checks, and audit correlation.",
  ...
  },
  {
    ...
    publicEvidence: [
      ...
      "Issue #420 adds owner-only broadcast test sends with exact confirmation, idempotency, audit correlation, stale-state checks, preview/footer checks, recipient/actor hash storage, and redaction before subscriber delivery exists.",
  ...
  },
  {
    ...
    publicEvidence: [
      ...
      "The first #420 slice adds owner-only broadcast test sends without subscriber delivery, Queue messages, recipient payloads, provider message IDs, or public agent sends.",
