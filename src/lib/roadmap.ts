...
export const roadmapItems: RoadmapItem[] = [
  ...
  },
  {
    ...
    publicEvidence: [
      ...
      "`/mobile-admin/source-data` exposes the shared mobile contract, private-auth boundary, private-row API summary, private-row action API summary, action-intent API summary, push boundary, distribution boundary, confirmed-action requirements, and no-installable-app caveat.",
  ...
  },
  {
    ...
    publicEvidence: [
      ...
      "Issue #417 adds owner-confirmed checkout unlinking, owner-confirmed resource delivery links, owner-session within-step block reordering, and owner-session cross-step block moves while tracking remaining freeform drag-and-drop editing, webinar integrations, physical deletion policy, live fulfillment automation, and direct agent-safe write tools after the MVP closeout.",
    ],
    nextMilestone:
