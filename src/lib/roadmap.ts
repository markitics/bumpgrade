...
export const roadmapItems: RoadmapItem[] = [
  ...
  },
  {
    ...
    nextMilestone: "Add confirmed subscriber import preflight records that reuse the safe importer audience review without creating live subscribers or sends.",
  },
  {
