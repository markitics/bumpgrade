...
export const roadmapItems: RoadmapItem[] = [
  ...
  },
  {
    ...
    nextMilestone:
      "Keep sequence enrollment and sends, private exports, checkout/payment credential migration, account transfer, domains, and fulfillment parked behind dedicated confirmed-write work; use the importer surface for private migration planning and audience review cleanup until those gates ship.",
  },
  {
