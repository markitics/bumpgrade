...
export const roadmapItems: RoadmapItem[] = [
  ...
  },
  {
    ...
    publicEvidence: [
      ...
      "Issue #417 adds owner-confirmed checkout unlinking, owner-confirmed resource delivery links, funnel-scoped private download-token delivery from published linked resource blocks, owner-confirmed webinar event/replay links, owner-session visual block style controls, owner-confirmed archived-draft purge with tombstone evidence, owner-session within-step block reordering, owner-session drag/drop block placement through existing move endpoints, owner-session cross-step block moves, and owner-session direct agent-safe draft writes for block copy edits, reusable block add/remove, checkout linking/unlinking, resource-delivery linking, webinar-event linking, block movement, duplication, public publishing, and archive/unpublish while tracking remaining full absolute-position canvas editing, full webinar integrations, bulk purge policy, live fulfillment automation, arbitrary uploaded private asset delivery, direct agent visual style writes, direct agent-created delivery tokens, unauthenticated public agent publishing, and direct agent purge after the MVP closeout.",
    ],
    nextMilestone:
      "Keep full absolute-position canvas editing, arbitrary uploaded private asset delivery, live fulfillment automation, full webinar integrations, bulk purge policy, direct agent visual style writes, direct agent-created delivery tokens, unauthenticated public agent publishing, and direct agent purge in issue #417; keep live publisher-offer billing in issue #219.",
  },
  {
    ...
    nextMilestone:
      "Design full absolute-position canvas editing, arbitrary uploaded private asset delivery, live fulfillment automation, full webinar integrations, bulk purge policy, direct agent visual style writes, direct agent-created delivery tokens, unauthenticated public agent publishing, and direct agent purge as one coherent post-MVP workflow instead of more single-gate readiness slices.",
  },
  {
