...
export const roadmapItems: RoadmapItem[] = [
  ...
  },
  {
    ...
    nextMilestone:
      "Keep arbitrary uploaded private asset delivery, live fulfillment automation, full webinar integrations, unauthenticated public agent-created delivery tokens, and unauthenticated public agent publishing in issue #417; keep live publisher-offer billing in issue #219.",
  },
  {
    ...
    publicEvidence: [
      ...
      "Issue #417 adds exact-confirmed bulk archived-draft purge with one tombstone per draft before deleting only archived draft and step rows.",
    ...
    nextMilestone:
      "Design arbitrary uploaded private asset delivery, live fulfillment automation, full webinar integrations, unauthenticated public agent-created delivery tokens, and unauthenticated public agent publishing as one coherent post-MVP workflow instead of more single-gate readiness slices.",
  },
  {
