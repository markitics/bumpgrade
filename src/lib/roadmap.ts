...
export const roadmapItems: RoadmapItem[] = [
  ...
  },
  {
    ...
    publicEvidence: [
      ...
      "Issue #417 adds owner-confirmed checkout unlinking and owner-confirmed resource delivery links while tracking remaining advanced funnel editing, webinar integrations, physical deletion policy, live fulfillment automation, and direct agent-safe write tools after the MVP closeout.",
    ],
    nextMilestone:
      "Keep advanced drag-and-drop editing, arbitrary private R2 delivery, live fulfillment automation, live webinar integrations, physical deletion policy, and direct agent-safe funnel tools in issue #417; keep live publisher-offer billing in issue #219.",
  },
  {
    ...
    group: "Funnels and pages",
    summary:
      "Active post-MVP funnel parity for drag-and-drop visual block editing, resource delivery, webinar integrations, physical deletion policy, and direct agent-safe write tools; owner-confirmed checkout unlinking and resource delivery links are now part of this bucket's shipped evidence.",
    publicEvidence: [
    ...
    nextMilestone:
      "Design drag-and-drop editing, arbitrary private R2 delivery, live fulfillment automation, live webinar integrations, physical deletion, and direct agent-safe write tools as one coherent post-MVP workflow instead of more single-gate readiness slices.",
  },
  {
