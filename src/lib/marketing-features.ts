...
export const marketingFeatures: MarketingFeature[] = [
  ...
  },
  {
    ...
    status: "live",
    availability:
      "Seeded analytics, source attribution, experiment assignment, time-window reports, aggregate export metadata, owner-reviewed cohort comparisons, owner-reviewed alert thresholds, owner-reviewed notification readiness, and owner-reviewed decision evidence are available.",
    eyebrow: "Know what worked",
    hero: "See which sources, variants, and launch paths are moving buyers.",
    summary:
      "Bumpgrade records privacy-safe events, page-view beacons, source attribution, experiment assignment, conversion reports, aggregate export metadata, owner-reviewed cohort comparisons, owner-reviewed alert threshold evidence, owner-reviewed notification readiness evidence, time-window summaries, and owner-reviewed experiment decisions.",
    ...
    issueIds: [18, 87, 105, 107, 119, 121, 123, 125, 127, 129, 261, 263, 265],
