...
export const checkoutOfferStack: CheckoutOfferStack = {
  ...
  summary:
    "A checkout offer stack with a primary product, optional order bump, post-purchase upsell path, referral attribution, and product delivery handoff.",
  primaryOffer: {
    ...
    customerPromise: "Get the launch pass and move into the launch workspace setup path.",
    placement: "Primary checkout line item",
    copyIntent: "Explain what the launch pass gives the buyer before checkout starts.",
    agentEditable: true,
  },
  orderBumps: [
    {
    ...
    offers: [
      {
        ...
        placement: "Post-purchase upsell after completed checkout.",
        copyIntent: "Present a limited follow-on offer without confusing the first purchase.",
        agentEditable: true,
      },
      {
