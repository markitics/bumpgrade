...
export const productAccessSourceData = {
  ...
  customerEntitlementLookup: {
    ...
    lookupEvidence: ["checkoutIntentId"],
    redaction: {
  ...
  caveat:
    "This contract proves product/access read and preview semantics, sandbox webhook-backed entitlement row grants, aggregate owner inspection, and customer-safe entitlement lookup by checkout intent evidence. It does not expose buyer identity, raw Stripe IDs, private R2 keys, signed URLs, protected content, revocation APIs, live fulfillment, customer portals, or direct agent confirmed-write APIs.",
};
