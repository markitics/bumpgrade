...
export const affiliateProgram: AffiliateProgram = {
  ...
  revisionId: "affiliate-program-revision-indie-launch-2026-05-21-fraud-review",
  summary:
    "An affiliate and referral scaffold for partner links, privacy-safe click capture, checkout attribution evidence, review-only commission ledger evidence, owner review/reversal actions, public-safe partner reports, read-only payout preparation, owner-confirmed payout preparation records, owner-reviewed fraud review evidence, and audit-safe agent access before payable commissions exist.",
  attributionRules: [
    {
...
export const affiliateReferralsSourceData = {
  ...
  status: "owner-fraud-review-records-ready",
  issue: 275,
  parentIssue: 19,
  ...
  caveat:
    "This contract proves affiliate and referral read/preview semantics, privacy-safe seeded click capture, checkout attribution evidence, review-only commission ledger evidence, owner-gated review/reversal actions, public-safe partner reports, read-only payout preparation, owner-confirmed payout preparation records, and owner-reviewed fraud review evidence. Public source-data may expose aggregate click, checkout attribution, commission ledger, owner action, partner report, payout preparation, payout preparation record, and fraud review record counts, but it does not expose raw rows, actor identity, private review reasons, private fraud signals, assign cookies, finalize buyer attribution, create payable commissions, store payout accounts, collect tax forms, trigger Stripe payouts, enforce fraud decisions, notify partners, or provide direct public agent write APIs.",
};
