...
export const affiliateProgram: AffiliateProgram = {
  ...
  revisionId: "affiliate-program-revision-indie-launch-2026-05-21-notification-send-preflight",
  summary:
    "An affiliate and referral scaffold for partner links, privacy-safe click capture, checkout attribution evidence, review-only commission ledger evidence, owner review/reversal actions, public-safe partner reports, read-only payout preparation, owner-confirmed payout preparation records, owner-reviewed fraud review evidence, owner-reviewed partner notification readiness evidence, owner-reviewed partner notification send preflight evidence, and audit-safe agent access before payable commissions or partner sends exist.",
  attributionRules: [
    {
