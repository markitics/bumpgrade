...
> = {
  ...
  "mobile-admin": {
    ...
    description:
      "iOS, Android, mobile dashboard source-data, simulator/emulator proof, mobile auth boundaries, private rows, private-row actions, Director reviews, commerce reviews, audit-only action intents, push readiness, and distribution readiness.",
    groupNames: ["Mobile"],
  },
  "agent-readiness": {
