...
> = {
  ...
  "mobile-admin": {
    ...
    description: "iOS, Android, mobile dashboard source-data, simulator/emulator proof, mobile auth boundaries, private rows, private-row actions, and audit-only action intents.",
    groupNames: ["Mobile"],
  },
  "agent-readiness": {
