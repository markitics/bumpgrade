...
const journeyProofByFeatureId: Record<string, AdminUserJourneyProof> = {
  ...
  "feature-analytics-testing": {
    ...
    notes: [
      "Reports, report export metadata, queue readiness, provider-call readiness, delivery-attempt readiness, delivery-result readiness, and decision evidence are aggregate and public-safe; raw visitor data, queue payload bodies, message consumption, acknowledgements, retry/dead-letter rows, provider calls, delivery attempts, delivery results, provider responses, provider message IDs, delivery receipts, status webhooks, provider polling, secrets, sender credentials, and sends are not exposed or enabled.",
    ],
  },
