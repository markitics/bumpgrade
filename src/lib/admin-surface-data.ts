...
const journeyProofByFeatureId: Record<string, AdminUserJourneyProof> = {
  "feature-funnel-builder": {
    ...
    summary: "Funnel previews, template library, draft admin, publishing, checkout linking, resource delivery links, and webinar/resource shapes have screenshot evidence.",
    ...
    notes: [
      "Issue #14 is the shipped funnel MVP proof. Issue #417 now includes owner-confirmed checkout unlinking and resource delivery links; live billing stays in issue #219; physical deletion, drag-and-drop editing, arbitrary private R2 delivery, live fulfillment automation, webinar integrations, and direct public agent writes stay in issue #417.",
      "Issue #215 adds owner-confirmed private draft duplication without copying checkout-link or resource-link metadata; issue #341 adds owner-confirmed archive/unpublish without deleting evidence; issue #417 adds owner-confirmed checkout unlinking and resource delivery links; issue #430 adds owner-session block title/body editing while preserving block metadata; issue #432 adds owner-session reusable block add/remove while refusing checkout-linked block removal.",
    ],
  },
...
const fallbackUserJourneys: AdminUserJourney[] = [
  ...
  },
  {
    ...
    validation: [
      ...
      "Issue #417 records owner-confirmed checkout unlinking, owner-confirmed resource delivery links, and the remaining advanced funnel parity follow-up after MVP closeout.",
    ],
    sortOrder: 46,
    updatedAt: null,
  },
  {
    ...
    edgeCases: [
      ...
      "Checkout-link deletion, physical deletion, drag-and-drop layout editing, live billing, direct agent resource delivery linking, arbitrary private R2 delivery, signed URLs, live fulfillment automation, direct agent block editing, direct agent block add/remove, direct agent duplication, and direct agent writes still require future confirmed-write APIs.",
