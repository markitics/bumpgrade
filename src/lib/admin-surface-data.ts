...
const journeyProofByFeatureId: Record<string, AdminUserJourneyProof> = {
  ...
  "feature-email-automation-crm": {
    ...
    method:
      "Opt-in, suppression, CRM note, sequence Queue consumer, sequence provider-call, sequence provider-polling, broadcast readiness, queue, provider, and dispatch readiness route checks.",
    summary:
