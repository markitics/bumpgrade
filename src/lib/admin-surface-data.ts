...
const journeyProofByFeatureId: Record<string, AdminUserJourneyProof> = {
  ...
  "feature-affiliates-referrals": {
    ...
    method:
      "Referral click, checkout attribution, commission ledger, review action, partner report, payout-prep, and owner payout-preparation record route checks.",
    summary:
      "Referral and affiliate evidence surfaces are proven; payout preparation records are owner-confirmed while payout mutation remains future-gated.",
    ciLinks: [{ label: "GitHub Actions", url: "https://github.com/markitics/bumpgrade/actions", kind: "ci" }],
    screenshotLinks: [
    ...
    notes: ["Payable commissions, Stripe payouts, payout accounts, tax records, and partner notifications remain outside the current proof."],
  },
...
const fallbackUserJourneys: AdminUserJourney[] = [
  ...
  },
  {
    ...
    featureId: "feature-affiliates-referrals",
    featureStatus: "launch-preview",
    issueNumbers: [19, 113, 115, 193, 195, 273],
    primaryUser: "Publisher reviewing affiliate payout readiness before payable state exists",
    userGoal:
      "Inspect read-only payout preparation rows, checklist blockers, partner-report links, and owner-confirmed payout preparation records before any Stripe payout, tax, payout account, or partner notification capability exists.",
    sourceEvidence: [
      "https://bumpgrade.com/affiliates/source-data",
      "https://bumpgrade.com/affiliates/indie-launch-partners",
    ...
    happyPath: [
      "Fetch /affiliates/source-data.",
      "Find payoutPreparationContract, payoutPreparationSummary, and payoutPreparationRecords.",
    ...
    edgeCases: [
      ...
      "Public preparation rows and owner-confirmed payout records never expose buyer data, raw ledger rows, raw actor identity, private reasons, partner payout accounts, tax forms, Stripe payout identifiers, or partner notification payloads.",
    ...
    validation: [
      "Playwright covers payoutPreparationContract, payoutPreparationSummary, owner-confirmed payout preparation records, preview rendering, admin journey exposure, agent manifest stable IDs, and redaction boundaries.",
      "Issues #195 and #273 record the read-only payout preparation slice and owner-confirmed payout preparation records.",
    ],
    sortOrder: 59,
    updatedAt: null,
  },
