...
const journeyProofByFeatureId: Record<string, AdminUserJourneyProof> = {
  "feature-funnel-builder": {
    ...
    notes: [
      "Issue #14 is the shipped funnel MVP proof. Live billing stays in issue #219; physical deletion, drag-and-drop editing, private resource delivery, webinar integrations, and direct public agent writes stay in issue #417.",
      "Issue #215 adds owner-confirmed private draft duplication without copying checkout-link metadata; issue #341 adds owner-confirmed archive/unpublish without deleting evidence.",
    ],
  },
...
const fallbackUserJourneys: AdminUserJourney[] = [
  ...
  },
  {
    ...
    validation: [
      ...
      "Issue #417 records the advanced funnel parity follow-up after MVP closeout.",
    ],
    sortOrder: 46,
    updatedAt: null,
  },
  {
    ...
    featureId: "feature-funnel-builder",
    featureStatus: "live",
    issueNumbers: [14, 79, 91, 93, 95, 135, 159, 161, 163, 165, 213, 215, 341, 409, 417],
