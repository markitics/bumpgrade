...
const fallbackUserJourneys: AdminUserJourney[] = [
  ...
  },
  {
    ...
    happyPath: [
      ...
      "Confirm the Expo, iOS, and Android surfaces render the live dashboard route, status, issue, and redaction boundary from the generated fixture.",
      ...
      "Follow iOS issue #67, Android issue #68, or dashboard issue #153 for implementation evidence.",
    ],
    edgeCases: [
    ...
    validation: [
      ...
      "Playwright covers /agent-docs/bumpgrade-mobile-admin, /mobile-admin/source-data, /mobile-admin/dashboard/source-data, /mobile-admin/ios/source-data, and /mobile-admin/android/source-data. Mobile validations assert the scaffold apps render the live dashboard panel.",
    ],
    sortOrder: 42,
    updatedAt: null,
  },
