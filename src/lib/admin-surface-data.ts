...
const fallbackUserJourneys: AdminUserJourney[] = [
  ...
  },
  {
    ...
    happyPath: [
      ...
      "Find the seeded affiliate program, revision ID, partner IDs, partner report IDs, payout preparation IDs, payout preparation record IDs, fraud review record IDs, partner notification readiness record IDs, referral link IDs, attribution rule IDs, commission rule IDs, fixture ledger IDs, payout batch ID, review flags, click capture API, checkout attribution contract, review-only commission ledger contract, owner review action contract, partner report contract, payout preparation contract, owner payout preparation record contract, owner fraud review record contract, owner notification readiness record contract, and write boundary.",
      ...
      "Read fraudReviewRecords and partnerNotificationReadinessRecords to inspect aggregate owner-reviewed fraud review and partner notification readiness evidence without private fraud signals, recipient data, message bodies, provider IDs, queue rows, or raw rows.",
      ...
      "As an owner, POST payout preparation, fraud review, and notification readiness records through /admin/affiliates with exact confirmation, idempotency, current revision checks, payout batch status checks, partner report checks, fraud review checks, and public-safe redaction.",
    ...
    edgeCases: [
      "Public source-data exposes aggregate click, checkout attribution, commission ledger, owner action, partner report, payout preparation, payout preparation record, fraud review record, and notification readiness record counts only, not raw click, checkout, buyer, actor, recipient, message, provider, queue, reason, private fraud signal, tax, payout, partner notification, or Stripe rows.",
      ...
      "Agents must not call review-only commission evidence, partner report totals, payout preparation rows, payout preparation records, fraud review records, or notification readiness records payable, send-ready partner statements, fraud enforcement, or published affiliate terms.",
    ],
    agentAccess:
      "Agents can read /affiliates/source-data, /commerce/source-data, preview routes, click capture boundaries, checkout attribution boundaries, review-only commission ledger boundaries, owner review action boundaries, public-safe partner reports, read-only payout preparation, owner-confirmed payout preparation records, owner-reviewed fraud review records, and owner-reviewed partner notification readiness records. Payout execution, fraud enforcement, tax, partner notification sends, provider calls, queue dispatch, private partner portal access, partner payout account storage, buyer attribution finalization, and direct agent affiliate writes require future authenticated confirmed-write APIs with actor identity, explicit confirmation, idempotency, stale-state checks, audit correlation, redaction, refund-window checks, payout review, private fraud review, and private payout data boundaries.",
    validation: [
  ...
  },
  {
    ...
    happyPath: [
      "Fetch /affiliates/source-data.",
      "Find payoutPreparationContract, payoutPreparationSummary, payoutPreparationRecords, fraudReviewRecords, and partnerNotificationReadinessRecords.",
      "Inspect each payoutPreparationId, linked payoutBatchId, partnerReportIds, eligible ledger IDs, blocked ledger IDs, reversed ledger IDs, readiness checklist, fraud review flag, notification readiness checklist, and public-safe aggregate totals.",
      ...
      "Treat the preparation, fraud review, and notification readiness rows as evidence only; do not call them payable commission state, partner statements, notification sends, or fraud enforcement.",
    ],
    edgeCases: [
      "Refund-window, owner-hold, self-referral evidence, missing recipient review, and disabled provider send paths keep notification readiness from becoming a send workflow.",
      "Public preparation rows, owner-confirmed payout records, owner-reviewed fraud records, and notification readiness records never expose recipient emails, message bodies, provider message IDs, queue rows, buyer data, raw ledger rows, raw click rows, raw checkout rows, raw actor identity, private fraud signals, partner payout accounts, tax forms, or Stripe payout identifiers.",
      "Stripe payouts, transfer creation, private partner portals, payout account storage, tax collection, fraud enforcement, payable commission finalization, partner notification sends, provider calls, queue dispatch, and direct agent writes require future confirmed-write APIs.",
    ],
    agentAccess:
    ...
    validation: [
      "Playwright covers payoutPreparationContract, payoutPreparationSummary, owner-confirmed payout preparation records, owner-reviewed fraud review records, owner-reviewed partner notification readiness records, preview rendering, admin journey exposure, agent manifest stable IDs, and redaction boundaries.",
      "Issues #195, #273, #275, and #277 record the read-only payout preparation slice, owner-confirmed payout preparation records, owner-reviewed fraud review records, and owner-reviewed partner notification readiness records.",
    ],
    sortOrder: 59,
    updatedAt: null,
  },
