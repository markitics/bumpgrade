...
const journeyProofById: Record<string, AdminUserJourneyProof> = {
  ...
  "journey-prospect-imports-from-clickfunnels": {
    ...
    screenshotLinks: [
      ...
      },
      {
        ...
        url: "https://bumpgrade.com/pr-screenshots/issue-467-private-export-review.png",
        kind: "screenshot",
      },
      {
      ...
      {
        label: "Subscriber import depth",
        url: "https://bumpgrade.com/pr-screenshots/issue-467-subscriber-import-depth.png",
        kind: "screenshot",
      },
      {
        label: "Subscriber import creation",
        url: "https://bumpgrade.com/pr-screenshots/issue-467-subscriber-import-creation.png",
        kind: "screenshot",
      },
      {
        label: "Subscriber audience promotion",
  ...
  "journey-prospect-saves-anonymous-playground": {
    ...
    screenshotLinks: [
      ...
      {
        label: "Anonymous playground save limits",
        url: "https://bumpgrade.com/pr-screenshots/issue-466-playground-save-limits.png",
        kind: "screenshot",
      },
      {
        label: "Anonymous playground claim merge",
        url: "https://bumpgrade.com/pr-screenshots/issue-466-playground-claim-merge.png",
        kind: "screenshot",
      },
    ],
    validationLinks: [
...
const journeyProofByFeatureId: Record<string, AdminUserJourneyProof> = {
  "feature-funnel-builder": {
    ...
    summary: "Funnel previews, template library, draft admin, publishing, checkout linking, resource delivery links, funnel-scoped private delivery tokens, redacted resource-delivery receipt evidence, webinar event/replay links, archived-draft purge, bulk archived-draft purge, visual style controls, block reordering, cross-step block moves, and webinar/resource shapes have screenshot evidence.",
    ...
    screenshotLinks: [
      ...
      {
        label: "Resource delivery receipts",
        url: "https://bumpgrade.com/pr-screenshots/issue-417-resource-delivery-receipts.png",
        kind: "screenshot",
      },
      {
      ...
      {
        label: "Bulk archived-draft purge",
        url: "https://bumpgrade.com/pr-screenshots/issue-417-bulk-purge-policy.png",
        kind: "screenshot",
      },
      {
  ...
  "feature-affiliates-referrals": {
    ...
    method:
      "Referral click, checkout attribution, commission ledger, review action, partner report, partner statement snapshot, payout-prep, owner payout-preparation record, owner fraud-review record, owner fraud-enforcement record, notification-readiness, send-preflight, provider-readiness, and grouped post-MVP execution-boundary route checks.",
    summary:
    ...
    screenshotLinks: [
      ...
      { label: "Partner statement snapshot", url: "https://bumpgrade.com/pr-screenshots/issue-424-partner-statement-snapshots.png", kind: "screenshot" },
...
const fallbackWorkLogEntries: AdminWorkLogEntry[] = [
  ...
  },
  {
    ...
    validation: [
      "Focused private SamCart importer checkout-readiness and redaction smoke coverage",
      "Typecheck",
      "Lint",
      "Runtime secrets",
      "Cloudflare build",
    ...
    firstPromptAt: "2026-05-26T21:20:00.000Z",
    completedAt: "2026-05-26T21:20:00.000Z",
    relevantUrls: [
      "https://bumpgrade.com/imports/source-data",
      "https://bumpgrade.com/imports/samcart/review",
  ...
  },
  {
    ...
    roadmapUpdated: ["roadmap-advanced-funnel-builder-parity", "roadmap-funnels"],
    userJourneysUpdated: ["journey-owner-seeds-editable-draft-funnel", "journey-publisher-previews-seeded-funnel"],
    ...
    validation: [
      "Typecheck",
      "Focused funnel source-data and owner-session draft-write smoke coverage",
      "Private preview and public published route canvas rendering checks",
      "Cloudflare build",
    ],
    flagsAttention:
    ...
    firstPromptAt: "2026-05-26T17:23:36.662Z",
    completedAt: "2026-05-26T19:10:00.000Z",
    relevantUrls: [
      "https://bumpgrade.com/admin/funnels",
      "https://bumpgrade.com/funnels/source-data",
      "https://bumpgrade.com/pr-screenshots/issue-417-funnel-canvas-layout-controls.png",
      "https://bumpgrade.com/admin/work-log",
    ],
    prCommentUrl: null,
  },
  {
    id: "work-log-2026-05-27-funnel-resource-delivery-receipts",
    title: "Added funnel resource-delivery receipt evidence",
    agentName: "Codex",
    agentKind: "codex",
    sessionName: "bumpgrade-build-heartbeat",
    promptFromMark:
    ...
    roadmapUpdated: ["roadmap-advanced-funnel-builder-parity", "roadmap-funnels"],
    userJourneysUpdated: ["journey-publisher-previews-seeded-funnel"],
    documentationUpdated: ["docs/features/funnels.md", "docs/agent/agent-ready.md", "public/llms.txt"],
    validation: [
      "Typecheck",
      "Focused funnel resource-delivery token and download-redemption smoke coverage",
      "Funnel source-data receipt summary checks",
      "Cloudflare build",
    ],
    flagsAttention:
      "Receipt evidence is recorded only after successful private download-token redemption and exposes safe funnel, block, product, asset, source, aggregate count, and redaction metadata only. It does not enable arbitrary uploaded asset delivery, signed URLs, live billing, live fulfillment automation, or unauthenticated public agent writes.",
    firstPromptAt: "2026-05-27T01:18:00.000Z",
    completedAt: "2026-05-27T02:00:00.000Z",
    relevantUrls: [
      "https://bumpgrade.com/admin/funnels",
      "https://bumpgrade.com/funnels/source-data",
      "https://bumpgrade.com/agent-docs/source-data",
      "https://bumpgrade.com/pr-screenshots/issue-417-resource-delivery-receipts.png",
      "https://bumpgrade.com/admin/work-log",
    ],
    prCommentUrl: null,
  },
  {
    id: "work-log-2026-05-26-funnel-bulk-purge-policy",
    title: "Added funnel bulk archived-draft purge",
    agentName: "Codex",
    agentKind: "codex",
    sessionName: "bumpgrade-build-heartbeat",
    promptFromMark:
    ...
    validation: [
      "Typecheck",
      "Focused funnel source-data and owner-session draft-write smoke coverage",
      "Admin and agent bulk purge tombstone replay checks",
      "Cloudflare build",
    ],
    flagsAttention:
    ...
    firstPromptAt: "2026-05-26T23:08:00.000Z",
    completedAt: "2026-05-26T23:40:00.000Z",
    relevantUrls: [
      "https://bumpgrade.com/admin/funnels",
      "https://bumpgrade.com/funnels/source-data",
      "https://bumpgrade.com/agent-docs/source-data",
      "https://bumpgrade.com/pr-screenshots/issue-417-bulk-purge-policy.png",
      "https://bumpgrade.com/admin/work-log",
    ],
    prCommentUrl: null,
  },
  {
    id: "work-log-2026-05-26-importer-subscriber-audience-promotion",
    title: "Added importer subscriber audience review-list promotion",
    agentName: "Codex",
    agentKind: "codex",
    sessionName: "bumpgrade-build-heartbeat",
    promptFromMark:
      "Mark asked for easy importers from ClickFunnels and competitor platforms, including import paths that help prospects move real work into Bumpgrade before go-live.",
    githubIssues: [{ number: 467, url: "https://github.com/markitics/bumpgrade/issues/467" }],
    closedPrs: [],
    featuresUpdated: [
      "https://bumpgrade.com/imports",
    ...
    documentationUpdated: ["docs/features/importers.md", "docs/agent/agent-ready.md", "public/llms.txt"],
    validation: [
      "Focused private Kit importer subscriber audience-promotion and redaction smoke coverage",
      "Typecheck",
      "Lint",
      "Runtime secrets",
      "Cloudflare build",
    ...
    flagsAttention:
      "Promotion creates imported-pending audience review rows and non-sending tag assignments only; consent events, sequence enrollments, sends, private exports, and go-live effects remain parked behind later gates.",
    firstPromptAt: "2026-05-26T16:28:00.000Z",
    completedAt: "2026-05-26T16:55:00.000Z",
    relevantUrls: [
      "https://bumpgrade.com/imports/source-data",
      "https://bumpgrade.com/audience/source-data",
      "https://bumpgrade.com/imports/kit/review",
      "https://bumpgrade.com/pr-screenshots/issue-467-subscriber-audience-promotion.png",
      "https://bumpgrade.com/admin/work-log",
    ],
    prCommentUrl: null,
  },
  {
    id: "work-log-2026-05-26-importer-subscriber-record-creation",
    title: "Added private subscriber record creation to importer review",
    agentName: "Codex",
    agentKind: "codex",
    sessionName: "bumpgrade-build-heartbeat",
    promptFromMark:
    ...
    documentationUpdated: ["docs/features/importers.md", "docs/agent/agent-ready.md", "public/llms.txt"],
    validation: [
      "Focused private Kit audience importer subscriber-creation and redaction smoke coverage",
      "Typecheck",
      "Lint",
      "Runtime secrets",
      "Cloudflare build",
    ...
    firstPromptAt: "2026-05-26T14:53:42.000Z",
    completedAt: "2026-05-26T15:11:00.000Z",
    relevantUrls: [
      "https://bumpgrade.com/imports/source-data",
      "https://bumpgrade.com/imports/kit/review",
      "https://bumpgrade.com/pr-screenshots/issue-467-subscriber-import-creation.png",
      "https://bumpgrade.com/admin/work-log",
    ],
    prCommentUrl: null,
  },
  {
    id: "work-log-2026-05-25-importer-subscriber-preflight-actions",
    title: "Added subscriber import preflight actions to importer review",
    agentName: "Codex",
    agentKind: "codex",
    sessionName: "bumpgrade-build-heartbeat",
    promptFromMark:
    ...
    documentationUpdated: ["docs/features/importers.md", "docs/agent/agent-ready.md", "public/llms.txt"],
    validation: [
      "Focused private Kit audience importer subscriber-preflight and redaction smoke coverage",
      "Typecheck",
      "Lint",
      "Runtime secrets",
      "Cloudflare build",
    ...
    firstPromptAt: "2026-05-26T11:37:00.000Z",
    completedAt: "2026-05-26T11:55:00.000Z",
    relevantUrls: [
      "https://bumpgrade.com/imports/source-data",
      "https://bumpgrade.com/imports/kit/review",
      "https://bumpgrade.com/admin/work-log",
  ...
  },
  {
    ...
    documentationUpdated: ["docs/features/importers.md", "docs/agent/agent-ready.md", "public/llms.txt"],
    validation: [
      "Focused private Kit audience importer subscriber-depth and redaction smoke coverage",
      "Typecheck",
      "Cloudflare build",
    ],
    flagsAttention:
      "No Mark action required. Live subscriber imports, sequence enrollment, sends, and private exports remain parked behind later confirmed-write gates.",
    firstPromptAt: "2026-05-26T09:53:00.000Z",
    completedAt: "2026-05-26T10:05:00.000Z",
    relevantUrls: [
      "https://bumpgrade.com/imports/source-data",
      "https://bumpgrade.com/imports/kit/review",
      "https://bumpgrade.com/pr-screenshots/issue-467-subscriber-import-depth.png",
      "https://bumpgrade.com/admin/work-log",
    ],
    prCommentUrl: null,
  },
  ...
  },
  {
    ...
    documentationUpdated: ["docs/features/importers.md", "docs/agent/agent-ready.md", "public/llms.txt"],
    validation: [
      "Focused private importer extracted-field and redaction smoke coverage",
      "Typecheck",
      "Lint",
      "Runtime secrets",
      "Cloudflare build",
    ...
    flagsAttention: null,
    firstPromptAt: "2026-05-26T08:35:00.000Z",
    completedAt: "2026-05-26T09:00:00.000Z",
    relevantUrls: [
      "https://bumpgrade.com/imports/source-data",
      "https://bumpgrade.com/imports/samcart/review",
      "https://bumpgrade.com/pr-screenshots/issue-467-import-record-field-extraction.png",
      "https://bumpgrade.com/admin/work-log",
    ],
    prCommentUrl: null,
  },
  {
    id: "work-log-2026-05-25-importer-private-record-actions",
    title: "Added private importer record review decisions",
    agentName: "Codex",
    agentKind: "codex",
    sessionName: "bumpgrade-build-heartbeat",
    promptFromMark:
    ...
    documentationUpdated: ["docs/features/importers.md", "docs/agent/agent-ready.md", "public/llms.txt"],
    validation: [
      "Focused private importer record action and redaction smoke coverage",
      "Typecheck",
      "Lint",
      "Runtime secrets",
      "Cloudflare build",
    ...
    flagsAttention: null,
    firstPromptAt: "2026-05-26T06:05:00.000Z",
  ...
  {
    id: "work-log-2026-05-25-importer-private-record-review",
    title: "Added private importer record review",
    agentName: "Codex",
    agentKind: "codex",
    sessionName: "bumpgrade-build-heartbeat",
    promptFromMark:
    ...
    documentationUpdated: ["docs/features/importers.md", "docs/agent/agent-ready.md", "public/llms.txt"],
    validation: [
      "Focused private importer record review and redaction smoke coverage",
      "Typecheck",
      "Lint",
      "Runtime secrets",
      "Cloudflare build",
    ...
    flagsAttention: null,
    firstPromptAt: "2026-05-26T05:25:00.000Z",
  ...
  {
    id: "work-log-2026-05-25-importer-structured-private-records",
    title: "Created structured private importer records",
    agentName: "Codex",
    agentKind: "codex",
    sessionName: "bumpgrade-build-heartbeat",
    promptFromMark:
    ...
    documentationUpdated: ["docs/features/importers.md", "docs/agent/agent-ready.md", "public/llms.txt"],
    validation: [
      "Focused private importer structured-record and redaction smoke coverage",
      "Typecheck",
      "Lint",
      "Runtime secrets",
      "Cloudflare build",
    ...
    flagsAttention: null,
    firstPromptAt: "2026-05-26T03:42:00.000Z",
    completedAt: "2026-05-26T04:05:00.000Z",
    relevantUrls: [
      "https://bumpgrade.com/imports/source-data",
      "https://bumpgrade.com/imports/samcart",
      "https://bumpgrade.com/admin/work-log",
  ...
  {
    id: "work-log-2026-05-25-importer-private-export-review",
    title: "Persisted private importer export review metadata",
    agentName: "Codex",
    agentKind: "codex",
    sessionName: "bumpgrade-build-heartbeat",
    promptFromMark:
    ...
    documentationUpdated: ["docs/features/importers.md", "docs/agent/agent-ready.md", "public/llms.txt"],
    validation: [
      "Focused private importer export review metadata and redaction smoke coverage",
      "Typecheck",
      "Lint",
      "Runtime secrets",
      "Cloudflare build",
    ...
    flagsAttention: null,
    firstPromptAt: "2026-05-26T03:03:00.000Z",
    completedAt: "2026-05-26T03:25:00.000Z",
    relevantUrls: [
      "https://bumpgrade.com/imports/source-data",
      "https://bumpgrade.com/imports/samcart",
      "https://bumpgrade.com/pr-screenshots/issue-467-private-export-review.png",
      "https://bumpgrade.com/admin/work-log",
    ],
    prCommentUrl: null,
  },
  {
    id: "work-log-2026-05-25-importer-platform-export-matches",
    title: "Added platform-specific importer export matching",
    agentName: "Codex",
    agentKind: "codex",
    sessionName: "bumpgrade-build-heartbeat",
    promptFromMark:
    ...
    documentationUpdated: ["docs/features/importers.md", "docs/agent/agent-ready.md", "public/llms.txt"],
    validation: [
      "Focused importer platform export match and redaction smoke coverage",
      "Typecheck",
      "Lint",
      "Runtime secrets",
      "Cloudflare build",
    ...
    flagsAttention: null,
    firstPromptAt: "2026-05-26T02:21:00.000Z",
  ...
  {
    id: "work-log-2026-05-25-importer-export-preflight-parser",
    title: "Added redacted importer export-file preflight parsing",
    agentName: "Codex",
    agentKind: "codex",
    sessionName: "bumpgrade-build-heartbeat",
    promptFromMark:
    ...
    documentationUpdated: ["docs/features/importers.md", "docs/agent/agent-ready.md", "public/llms.txt"],
    validation: [
      "Focused importer export-file preflight parser and redaction smoke coverage",
      "Typecheck",
      "Lint",
      "Runtime secrets",
      "Cloudflare build",
    ...
    flagsAttention: null,
    firstPromptAt: "2026-05-26T01:46:00.000Z",
  ...
  {
    id: "work-log-2026-05-25-importer-platform-preflight-extraction",
    title: "Added platform-specific importer preflight extraction",
    agentName: "Codex",
    agentKind: "codex",
    sessionName: "bumpgrade-build-heartbeat",
    promptFromMark:
    ...
    documentationUpdated: ["docs/features/importers.md", "docs/agent/agent-ready.md", "public/llms.txt"],
    validation: [
      "Focused importer preflight/source-data and dedicated route smoke coverage",
      "Typecheck",
      "Lint",
      "Runtime secrets",
      "Cloudflare build",
    ...
    flagsAttention: null,
    firstPromptAt: "2026-05-26T01:07:00.000Z",
    completedAt: "2026-05-26T01:25:00.000Z",
    relevantUrls: [
      "https://bumpgrade.com/imports/source-data",
      "https://bumpgrade.com/imports/samcart",
      "https://bumpgrade.com/admin/work-log",
  ...
  {
    id: "work-log-2026-05-25-anonymous-playground-claim-merge",
    title: "Made playground claims additive for existing Free Build workspaces",
    agentName: "Codex",
    agentKind: "codex",
    sessionName: "bumpgrade-build-heartbeat",
    promptFromMark:
      "Owner asked for logged-out product play that saves progress without losing work, then preserves that work when a user signs up or pays.",
    ...
    validation: [
      ...
      "lint",
      "Cloudflare build",
      "focused Playwright smoke for existing Free Build workspace claim merge, anonymous playground source-data, pricing/account source-data, agent docs, and public copy",
    ],
    flagsAttention: null,
    firstPromptAt: "2026-05-25T20:25:57.422Z",
    ...
    relevantUrls: [
      ...
      "https://bumpgrade.com/pricing/source-data",
      "https://bumpgrade.com/account/source-data",
      "https://bumpgrade.com/pr-screenshots/issue-466-playground-claim-merge.png",
      "https://bumpgrade.com/admin/work-log",
    ],
    prCommentUrl: null,
  },
  {
    id: "work-log-2026-05-25-anonymous-playground-save-limits",
    title: "Added anonymous playground save limits",
    agentName: "Codex",
    agentKind: "codex",
    sessionName: "bumpgrade-build-heartbeat",
    promptFromMark:
      "Owner asked for logged-out product play that saves progress without losing work, with honest public copy and agent-readable boundaries.",
    githubIssues: [{ number: 466, url: "https://github.com/markitics/bumpgrade/issues/466" }],
    closedPrs: [],
    featuresUpdated: [
      "https://bumpgrade.com/playground",
    ...
    validation: [
      ...
      "runtime secrets",
      "Cloudflare build",
      "focused Playwright smoke for anonymous playground save limits/source-data/admin copy",
      "live smoke after deploy",
    ],
    flagsAttention: null,
    firstPromptAt: "2026-05-25T20:25:57.422Z",
    completedAt: "2026-05-26T07:05:00.000Z",
    relevantUrls: [
      "https://bumpgrade.com/playground",
      "https://bumpgrade.com/playground/source-data",
      "https://bumpgrade.com/admin/work-log",
  ...
  },
  {
    ...
    flagsAttention:
      "This gives verified owners curated block-level visual styling without arbitrary CSS, script injection, live billing, live fulfillment automation, direct agent purge, or unauthenticated public writes.",
  ...
  },
  {
    ...
    flagsAttention:
      "This purge is intentionally narrow: archived draft and step rows only, with a tombstone first. Bulk archived-draft purge is handled by a later owner-confirmed checkpoint; non-archived purge, audit deletion, product assets, R2 objects, buyer records, and billing state remain out of scope.",
    firstPromptAt: "2026-05-24T01:37:20.997Z",
...
const fallbackUserJourneys: AdminUserJourney[] = [
  ...
  },
  {
    ...
    happyPath: [
      ...
      "Inspect redacted resource-delivery receipt metadata so successful private download redemption is distinguishable from live fulfillment automation or signed URL delivery.",
    ...
    validation: [
      ...
      "Issue #417 records owner-confirmed checkout unlinking, owner-confirmed resource delivery links, funnel-scoped private delivery tokens, owner-session agent-created resource delivery tokens, redacted resource-delivery receipt evidence, owner-confirmed webinar event/replay links, owner-confirmed archived-draft purge, owner-session visual style controls, bounded canvas layout controls, owner-session within-step block reordering, owner-session drag/drop block placement, owner-session cross-step block moves, owner-session direct agent public publishing, and the remaining advanced funnel parity follow-up after MVP closeout.",
    ],
    sortOrder: 46,
    updatedAt: null,
  },
  {
    ...
    happyPath: [
      ...
      "As an owner-session agent, submit the same published resource block, checkout intent, entitlement, current published revision, exact confirmation text, idempotency key, and audit correlation ID to /api/agent/funnels/resource-delivery-tokens, then confirm replay returns redacted audit metadata without the raw token.",
    ...
    edgeCases: [
      ...
      "Non-archived purge, live billing, unauthenticated public agent-created delivery tokens, arbitrary uploaded private asset delivery, signed URLs, live fulfillment automation, live webinar scheduling, attendance tracking, replay hosting, unauthenticated public agent publishing, and broad direct agent writes beyond private block copy edits, visual style presets, bounded canvas layouts, reusable block add/remove, checkout linking/unlinking, block movement, resource-delivery linking, webinar-event linking, private duplication, public publishing, archive/unpublish, archived-draft purge, and bulk archived-draft purge still require future confirmed-write APIs.",
    ...
    validation: [
      ...
      "Issue #341 records owner-confirmed archive/unpublish lifecycle actions.",
      "Issue #409 records owner-created product delivery-gate links for the seeded offer/funnel path.",
      "Issue #417 records owner-confirmed checkout unlinking, owner-confirmed resource delivery links, funnel-scoped private delivery tokens, redacted resource-delivery receipt evidence, owner-confirmed webinar event/replay links, owner-confirmed archived-draft purge, owner-session visual style controls, owner-session within-step block reordering, owner-session cross-step block moves, owner-session direct agent public publishing, and the remaining advanced funnel parity follow-up after MVP closeout.",
      "Issue #430 records owner-session granular draft block title/body editing.",
      "Issue #432 records owner-session reusable block add/remove controls with checkout-linked block protection.",
    ],
    sortOrder: 47,
  ...
  },
  {
    ...
    happyPath: [
      ...
      "Find event IDs, page-view beacon boundary, custom routing rule IDs, aggregate source attribution counts, aggregate variant event counts, fixed time windows, metric IDs, aggregate event counts, aggregate conversion report rows, experiment IDs, variant IDs, assignment rule, assignment API, dashboard source section, and write boundary.",
      ...
      "Open /funnels/indie-launch-sandbox with a recognized safe UTM source or campaign and let the session-idempotent assignment route the opt-in hero copy by custom rule, then let the page-view beacon record a seeded event with that same variant ID and normalized source attribution.",
    ...
    edgeCases: [
      "Public source-data exposes aggregate counts, aggregate source attribution counts, aggregate variant counts, custom routing rule metadata, fixed-window metadata, report export metadata, owner-reviewed cohort comparison evidence, owner-reviewed alert threshold/anomaly-review evidence, owner-reviewed notification delivery readiness evidence, owner-confirmed notification inbox aggregate evidence, owner-confirmed dispatch preflight aggregate evidence, owner-reviewed provider/domain readiness aggregate evidence, owner-reviewed content/consent readiness aggregate evidence, owner-reviewed send-payload readiness aggregate evidence, owner-reviewed queue-producer readiness aggregate evidence, owner-reviewed queue-consumer readiness aggregate evidence, owner-reviewed provider-call readiness aggregate evidence, owner-reviewed delivery-attempt readiness aggregate evidence, owner-reviewed delivery-result readiness aggregate evidence, owner-reviewed delivery-status webhook readiness aggregate evidence, owner-reviewed provider-polling readiness aggregate evidence, owner-reviewed receipt-payload readiness aggregate evidence, owner-reviewed delivery-receipt readiness aggregate evidence, owner-reviewed provider-status reconciliation readiness aggregate evidence, and conversion rows only, not raw event, raw routing URLs, or assignment rows.",
  ...
  },
  {
    ...
    userGoal:
      "Inspect referral link, aggregate performance, review-only statement snapshot, payout-readiness blockers, fraud status, and notification readiness without exposing buyer data, payout accounts, tax forms, Stripe identifiers, provider secrets, message bodies, queue rows, raw rows, or private fraud signals.",
    sourceEvidence: [
    ...
    agentAccess:
      "Agents can read the partner portal page plus /affiliates/source-data.partnerPortalSummary and partnerStatementSnapshotSummary as public-safe status. Authenticated private partner access, payable statements, payout execution, provider sends, and direct agent affiliate writes require future confirmed-write APIs and private auth boundaries.",
    validation: [
