...
const fallbackUserJourneys: AdminUserJourney[] = [
  ...
  },
  {
    ...
    happyPath: [
      ...
      "Inspect block reorder and cross-step move capability metadata so owner-session block positioning and drag/drop placement are distinguishable from freeform canvas styling.",
    ...
    validation: [
      ...
      "Issue #417 records owner-confirmed checkout unlinking, owner-confirmed resource delivery links, owner-confirmed webinar event/replay links, owner-confirmed archived-draft purge, owner-session within-step block reordering, owner-session drag/drop block placement, owner-session cross-step block moves, and the remaining advanced funnel parity follow-up after MVP closeout.",
    ],
    sortOrder: 46,
    updatedAt: null,
  },
  ...
  },
  {
    ...
    edgeCases: [
      ...
      "Mobile writes are limited to low-risk private-row workflow actions and Director workstream acknowledgements until additional confirmed-write APIs exist.",
