...
const fallbackUserJourneys: AdminUserJourney[] = [
  ...
  },
  {
    ...
    edgeCases: [
      ...
      "Owner-only broadcast test sends may send to the verified owner-session email only; they do not store raw recipient emails, raw email bodies, provider message IDs, subscriber payloads, Queue messages, or public agent sends.",
