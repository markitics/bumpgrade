...
const fallbackUserJourneys: AdminUserJourney[] = [
  ...
  },
  {
    ...
    issueNumbers: [14, 79, 159],
    primaryUser: "Publisher or agent planning the first funnel",
    userGoal:
      "Inspect an ordered opt-in, sales, and thank-you funnel plus reusable templates and block records before visual editing, template-to-draft creation, and checkout-linking writes exist.",
    sourceEvidence: [
    ...
    happyPath: [
      ...
      "Inspect reusable funnel templates and block-template records, including draftCreation and block write boundaries.",
    ...
    edgeCases: [
      ...
      "Template-to-draft creation, checkout linking, deletion, unpublishing, and direct agent edits require future confirmed-write APIs.",
      "Generated copy remains draft until a publisher confirms it.",
    ],
    agentAccess:
      "Agents can read /funnels/source-data, reusable template and block-template records, the seeded preview route, and published D1 funnel routes. Funnel writes require actor identity, confirmation, idempotency, stale-state checks, audit correlation, redaction, and rollback notes.",
    validation: [
