...
const fallbackUserJourneys: AdminUserJourney[] = [
  ...
  },
  {
    ...
    edgeCases: [
      ...
      "Real subscriber imports, direct agent contact writes, real sequence scheduling, real email sends, body templates, unsubscribe URLs, delivery queue rows, Cloudflare Queue messages, queue payload bodies, Queue producer execution, Queue consumer execution, private exports, export file creation, and CRM automation require future confirmed-write APIs.",
      "Codex project email in issue #10 is separate from publisher/customer email workflows.",
    ],
    agentAccess:
      "Agents can read /audience/source-data, aggregate subscriber/suppression/timeline/sequence-delivery-readiness/sequence-schedule-intent/sequence-delivery-batch/sequence-queue-message/sequence-dispatch-preflight/broadcast readiness/broadcast schedule-intent/preview safety/queue readiness/delivery-batch/queue-message/dispatch-preflight/dispatch-attempt/sender-domain/provider-event/provider rate-limit/provider response/send-payload/Queue producer/Queue consumer/import-intent/import-preflight/export-readiness counts, and the opt-in/unsubscribe/note/sequence-schedule-intent/sequence-delivery-batch/sequence-queue-message/sequence-dispatch-preflight/broadcast-schedule-intent/delivery-batch/queue-message/dispatch-preflight/dispatch-attempt/import-intent/import-preflight write boundaries. Owner sessions can inspect private rows, create private notes, view aggregate sequence delivery readiness, record dry-run sequence schedule intents, record dry-run sequence delivery batches, record dry-run sequence queue-message evidence, record dry-run sequence dispatch preflight evidence, view broadcast readiness, inspect preview safety, queue readiness, sender-domain readiness, provider-event readiness, provider rate-limit readiness, provider response readiness, send-payload readiness, Queue producer readiness, Queue consumer readiness, import intent records, import preflight records, and aggregate export readiness, and record dry-run broadcast schedule intents, delivery-batch dry runs, queue-message dry runs, dispatch preflight dry runs, dispatch attempt receipts, non-destructive import intents, and aggregate import preflights in /admin/audience. Direct agent subscriber writes, real imports, real sequence scheduling, real sends, private exports, export file creation, provider setup, provider webhooks, Queue producer execution, Queue consumer execution, or CRM automation require future authenticated confirmed-write APIs with consent, suppression, sender-domain safety, provider-event safety, provider rate-limit safety, provider response safety, send-payload safety, Queue producer safety, Queue consumer safety, queue safety, and audit correlation.",
    validation: [
      "Playwright covers /audience/source-data, aggregate subscriber/suppression/timeline/sequence-delivery-readiness/sequence-schedule-intent/sequence-delivery-batch/sequence-queue-message/sequence-dispatch-preflight/broadcast readiness/broadcast schedule-intent/preview safety/queue readiness/delivery-batch/queue-message/dispatch-preflight/dispatch-attempt/sender-domain/provider-event/provider rate-limit/provider response/send-payload/Queue producer/Queue consumer/import-intent/import-preflight/export-readiness redaction, /audience/indie-launch-waitlist, valid opt-in, unsubscribe, unknown-email suppression, owner /admin/audience inspection, owner CRM note creation, owner sequence schedule-intent creation, owner sequence delivery-batch creation, owner sequence queue-message creation, owner sequence dispatch-preflight creation, owner broadcast schedule-intent creation, owner delivery-batch creation, owner queue-message creation, owner dispatch-preflight creation, owner dispatch-attempt creation, owner import-intent creation, owner import-preflight creation, unauthorized note/schedule-intent/sequence-delivery-batch/sequence-queue-message/sequence-dispatch-preflight/delivery-batch/queue-message/dispatch-preflight/dispatch-attempt/import-intent/import-preflight rejection, validation failures, duplicate idempotency, sitemap discovery, and agent manifest discovery.",
      "Issues #85, #103, #137, #167, #169, #171, #173, #175, #177, #183, #189, #191, #197, #199, #201, #203, #205, #207, #209, #211, #253, #259, #347, #351, #354, #358, #360, and #362 record the audience automation source-data contract, first live opt-in capture path, owner subscriber inspection path, unsubscribe/suppression path, owner CRM timeline note path, broadcast readiness path, dry-run broadcast schedule intent path, broadcast preview safety path, queue readiness path, delivery-batch dry-run path, queue-message dry-run path, dispatch-preflight dry-run path, dispatch-attempt receipt path, sender-domain readiness path, provider-event readiness path, provider rate-limit readiness path, provider response readiness path, send-payload readiness path, Queue producer readiness path, Queue consumer readiness path, owner import-intent path, owner import-preflight path, aggregate export-readiness path, aggregate sequence-delivery-readiness path, dry-run sequence schedule-intent path, dry-run sequence delivery-batch path, dry-run sequence queue-message path, and dry-run sequence dispatch-preflight path.",
    ],
    sortOrder: 50,
    updatedAt: null,
  },
