...
const fallbackUserJourneys: AdminUserJourney[] = [
  ...
  },
  {
    ...
    userGoal:
      "Inspect products, assets, access rules, entitlement templates, sandbox entitlement grant mappings, owner entitlement rows, revocation intent readiness, and protected fixture delivery checks before real private content storage is enabled.",
    sourceEvidence: [
  ...
  },
  {
    ...
    userGoal:
      "Confirm that a paid sandbox checkout webhook can grant product entitlements, queue fulfillment evidence, expose revocation intent readiness, and return protected fixtures only for active eligible checkout-linked entitlements.",
    sourceEvidence: [
      "https://bumpgrade.com/products/source-data",
      "https://bumpgrade.com/products/entitlements",
      "https://bumpgrade.com/api/products/entitlements",
