...
const journeyProofByFeatureId: Record<string, AdminUserJourneyProof> = {
  ...
  "feature-analytics-testing": {
    ...
    summary:
      "Analytics preview, aggregate conversion reporting, source attribution, time windows, aggregate report export metadata, and owner-confirmed experiment decision evidence have proof surfaces.",
    ciLinks: [{ label: "GitHub Actions", url: "https://github.com/markitics/bumpgrade/actions", kind: "ci" }],
    screenshotLinks: [
...
const fallbackUserJourneys: AdminUserJourney[] = [
  ...
  },
  {
    ...
    edgeCases: [
      "Public source-data exposes aggregate counts, aggregate source attribution counts, aggregate variant counts, fixed-window metadata, report export metadata, owner-reviewed cohort comparison evidence, owner-reviewed alert threshold/anomaly-review evidence, owner-reviewed notification delivery readiness evidence, owner-confirmed notification inbox aggregate evidence, and conversion rows only, not raw event or assignment rows.",
    ...
    validation: [
      "Playwright covers /analytics/source-data, /analytics/source-data?window=24h, /analytics/indie-launch-dashboard fixed-window source attribution UI, /admin/analytics owner decision and notification inbox evidence, aggregate report export metadata, owner-reviewed cohort comparison evidence, owner-reviewed alert threshold/anomaly-review evidence, owner-reviewed notification delivery readiness evidence, owner-confirmed notification inbox evidence, event ingestion, page-view beacon capture with variant and source attribution evidence, bot suppression, assignment ingestion, conversion reporting from captured events, duplicate idempotency, deterministic assignment, validation failures, opt-in event recording, sitemap discovery, and agent manifest discovery.",
      "Issues #87, #105, #107, #119, #121, #123, #125, #127, #129, #261, #263, #265, #267, #269, and #271 record the analytics source-data scaffold, first privacy-safe event capture path, first deterministic assignment path, first aggregate conversion report, first browser-side funnel page-view beacon, first variant-linked page-view evidence, first aggregate source attribution evidence, first dashboard-visible source breakdown, first fixed-window aggregate filters, first owner-confirmed experiment decision evidence, first aggregate report export metadata, owner-reviewed cohort comparison evidence, owner-reviewed alert threshold/anomaly-review evidence, owner-reviewed notification delivery readiness evidence, and owner-confirmed notification inbox records.",
    ],
    sortOrder: 51,
    updatedAt: null,
  },
  ...
  },
  {
    ...
    happyPath: [
      ...
      "Find the seeded affiliate program, revision ID, partner IDs, partner report IDs, payout preparation IDs, payout preparation record IDs, fraud review record IDs, partner notification readiness record IDs, partner notification send preflight record IDs, referral link IDs, attribution rule IDs, commission rule IDs, fixture ledger IDs, payout batch ID, review flags, click capture API, checkout attribution contract, review-only commission ledger contract, owner review action contract, partner report contract, payout preparation contract, owner payout preparation record contract, owner fraud review record contract, owner notification readiness record contract, owner notification send preflight record contract, and write boundary.",
      ...
      "Read fraudReviewRecords, partnerNotificationReadinessRecords, and partnerNotificationSendPreflightRecords to inspect aggregate owner-reviewed fraud review, partner notification readiness, and send preflight evidence without private fraud signals, recipient data, message bodies, send payloads, provider IDs, queue rows, or raw rows.",
      ...
      "As an owner, POST payout preparation, fraud review, notification readiness, and notification send preflight records through /admin/affiliates with exact confirmation, idempotency, current revision checks, payout batch status checks, partner report checks, fraud review checks, notification readiness checks, provider-send-disabled checks, and public-safe redaction.",
    ...
    edgeCases: [
      "Public source-data exposes aggregate click, checkout attribution, commission ledger, owner action, partner report, payout preparation, payout preparation record, fraud review record, notification readiness record, and notification send preflight record counts only, not raw click, checkout, buyer, actor, recipient, message, send payload, provider, queue, reason, private fraud signal, tax, payout, partner notification, or Stripe rows.",
      ...
      "Agents must not call review-only commission evidence, partner report totals, payout preparation rows, payout preparation records, fraud review records, notification readiness records, or notification send preflight records payable, send-ready partner statements, fraud enforcement, provider-send configuration, or published affiliate terms.",
    ],
    agentAccess:
      "Agents can read /affiliates/source-data, /commerce/source-data, preview routes, click capture boundaries, checkout attribution boundaries, review-only commission ledger boundaries, owner review action boundaries, public-safe partner reports, read-only payout preparation, owner-confirmed payout preparation records, owner-reviewed fraud review records, owner-reviewed partner notification readiness records, and owner-reviewed partner notification send preflight records. Payout execution, fraud enforcement, tax, partner notification sends, provider-send enablement, provider calls, send payload creation, queue dispatch, private partner portal access, partner payout account storage, buyer attribution finalization, and direct agent affiliate writes require future authenticated confirmed-write APIs with actor identity, explicit confirmation, idempotency, stale-state checks, audit correlation, redaction, refund-window checks, payout review, private fraud review, notification send preflight checks, and private payout data boundaries.",
    validation: [
  ...
  },
  {
    ...
    happyPath: [
      "Fetch /affiliates/source-data.",
      "Find payoutPreparationContract, payoutPreparationSummary, payoutPreparationRecords, fraudReviewRecords, partnerNotificationReadinessRecords, and partnerNotificationSendPreflightRecords.",
      "Inspect each payoutPreparationId, linked payoutBatchId, partnerReportIds, eligible ledger IDs, blocked ledger IDs, reversed ledger IDs, readiness checklist, fraud review flag, notification readiness checklist, notification send preflight checklist, provider-send-disabled state, and public-safe aggregate totals.",
      ...
      "Treat the preparation, fraud review, notification readiness, and notification send preflight rows as evidence only; do not call them payable commission state, partner statements, notification sends, provider-send configuration, or fraud enforcement.",
    ],
    edgeCases: [
      "Refund-window, owner-hold, self-referral evidence, missing recipient review, disabled provider send paths, and absent send payloads keep notification readiness and send preflight from becoming a send workflow.",
      "Public preparation rows, owner-confirmed payout records, owner-reviewed fraud records, notification readiness records, and notification send preflight records never expose recipient emails, message bodies, send payloads, provider message IDs, queue rows, buyer data, raw ledger rows, raw click rows, raw checkout rows, raw actor identity, private fraud signals, partner payout accounts, tax forms, or Stripe payout identifiers.",
      "Stripe payouts, transfer creation, private partner portals, payout account storage, tax collection, fraud enforcement, payable commission finalization, partner notification sends, provider-send enablement, provider calls, queue dispatch, and direct agent writes require future confirmed-write APIs.",
    ],
    agentAccess:
    ...
    validation: [
      ...
      "Issues #195, #273, #275, #277, and #279 record the read-only payout preparation slice, owner-confirmed payout preparation records, owner-reviewed fraud review records, owner-reviewed partner notification readiness records, and owner-reviewed partner notification send preflight records.",
    ],
    sortOrder: 59,
    updatedAt: null,
  },
