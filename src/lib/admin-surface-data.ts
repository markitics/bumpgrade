...
const journeyProofByFeatureId: Record<string, AdminUserJourneyProof> = {
  ...
  "feature-analytics-testing": {
    status: "passed",
    lastTestedAt: "2026-05-21T23:05:00.000Z",
    environment: "Production screenshot and analytics source-data evidence.",
    method:
      "Analytics event, page-view beacon, source attribution, variant, time-window, report-export, staged notification readiness through receipt-payload readiness, and owner decision-evidence route checks.",
    summary:
      "Analytics preview, aggregate conversion reporting, source attribution, time windows, aggregate report export metadata, owner-confirmed experiment decision evidence, owner-reviewed content/consent readiness, owner-reviewed send-payload readiness, owner-reviewed queue-producer readiness, owner-reviewed queue-consumer readiness, owner-reviewed provider-call readiness, owner-reviewed delivery-attempt readiness, owner-reviewed delivery-result readiness, owner-reviewed delivery-status webhook readiness, owner-reviewed provider-polling readiness, owner-reviewed receipt-payload readiness, and owner-reviewed delivery-receipt readiness have proof surfaces.",
    ciLinks: [{ label: "GitHub Actions", url: "https://github.com/markitics/bumpgrade/actions", kind: "ci" }],
    screenshotLinks: [
    ...
    notes: [
      "Reports, report export metadata, queue readiness, provider-call readiness, delivery-attempt readiness, delivery-result readiness, delivery-status webhook readiness, provider-polling readiness, receipt-payload readiness, delivery-receipt readiness, and decision evidence are aggregate and public-safe; raw visitor data, queue payload bodies, message consumption, acknowledgements, retry/dead-letter rows, provider calls, delivery attempts, delivery results, delivery status webhooks, provider responses, provider message IDs, delivery receipts, receipt payloads, status webhooks, provider polling, secrets, sender credentials, and sends are not exposed or enabled.",
    ],
  },
...
const fallbackUserJourneys: AdminUserJourney[] = [
  ...
  },
  {
    ...
    happyPath: [
      ...
      "Open /pricing-v2 to review the usage-based pricing exploration before final packaging is chosen.",
    ...
    edgeCases: [
      ...
      "The usage-based pricing exploration is not a live checkout, final price list, or entitlement contract.",
    ...
    validation: [
      "Playwright covers /users, /resources, /pricing, /pricing-v2, /content/source-data, sitemap discovery, and agent manifest read-contract discovery.",
      "Issue #20 updates public route metadata and source-data contracts.",
      "Issue #317 adds a usage-based pricing exploration with public-safe source data.",
    ],
  ...
  },
  {
    ...
    featureId: "feature-resources-use-cases-pricing",
    featureStatus: "live",
    issueNumbers: [20, 46, 217, 222, 223, 225, 226, 234, 317],
    ...
    sourceEvidence: [
      "https://bumpgrade.com/pricing",
      "https://bumpgrade.com/pricing-v2",
      "https://bumpgrade.com/pricing-v2/source-data",
    ...
    happyPath: [
      ...
      "Open /pricing-v2 to compare usage-based packaging before choosing the self-serve model.",
    ...
    edgeCases: [
      ...
      "/pricing-v2 is an exploration and must not be cited as final subscription pricing.",
    ...
    agentAccess:
      "Agents can read /pricing, /pricing-v2, /pricing-v2/source-data, and /content/source-data, but billing-impacting recommendations must cite /commerce/source-data and current Stripe proof.",
    validation: [
      ...
      "Issue #317 adds the usage-based pricing exploration and source-data route without live checkout claims.",
