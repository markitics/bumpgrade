...
const fallbackUserJourneys: AdminUserJourney[] = [
  ...
  },
  {
    ...
    happyPath: [
      ...
      "Find seeded product types, asset IDs, access rules, entitlement templates, sandbox grant mappings, aggregate entitlement inspection counts, customer lookup contract, private R2-backed delivery contract, owner-upload intent contract, revocation intent readiness, revision ID, and write boundary.",
  ...
  },
  {
    ...
    happyPath: [
      ...
      "Open /admin/products as a verified owner to inspect the entitlement rows, queued fulfillment evidence, and revocation intent readiness.",
    ],
    edgeCases: [
