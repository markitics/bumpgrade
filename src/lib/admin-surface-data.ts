...
const journeyProofByFeatureId: Record<string, AdminUserJourneyProof> = {
  "feature-funnel-builder": {
    ...
    summary: "Funnel previews, template library, draft admin, publishing, checkout linking, resource delivery links, funnel-scoped private delivery tokens, webinar event/replay links, archived-draft purge, block reordering, cross-step block moves, and webinar/resource shapes have screenshot evidence.",
    ...
    notes: [
      "Issue #14 is the shipped funnel MVP proof. Issue #417 now includes owner-confirmed checkout unlinking, resource delivery links, funnel-scoped private delivery tokens, webinar event/replay links, archived-draft purge, owner-session within-step block reordering, owner-session drag/drop block placement through existing move endpoints, and owner-session cross-step block moves; live billing stays in issue #219; bulk purge policy, freeform canvas styling, arbitrary uploaded private asset delivery, live fulfillment automation, full webinar integrations, direct agent-created delivery tokens, and direct public agent writes stay in issue #417.",
...
const fallbackUserJourneys: AdminUserJourney[] = [
  ...
  },
  {
    ...
    edgeCases: [
      ...
      "Checkout-link deletion, non-archived purge, bulk purge, freeform canvas layout styling, live billing, direct agent cross-step block moves, direct agent purge, direct agent resource delivery linking, direct agent-created delivery tokens, direct agent webinar event linking, arbitrary uploaded private asset delivery, signed URLs, live fulfillment automation, live webinar scheduling, attendance tracking, replay hosting, direct agent block editing, direct agent block add/remove, direct agent block reordering, direct agent duplication, and direct agent writes still require future confirmed-write APIs.",
