...
const fallbackUserJourneys: AdminUserJourney[] = [
  ...
  },
  {
    ...
    userGoal: "Open the future Bumpgrade mobile app to check roadmap, work-log, for-Mark attention, commerce health, owner-session boundaries, confirmed-action requirements, push readiness, and distribution readiness without separate mobile-only semantics.",
    sourceEvidence: [
    ...
    validation: [
      ...
      "Playwright covers /agent-docs/bumpgrade-mobile-admin, /mobile-admin/source-data, /mobile-admin/dashboard/source-data, /mobile-admin/ios/source-data, /mobile-admin/android/source-data, push-readiness redaction, and distribution-readiness blockers. Mobile validations assert the scaffold apps render and live-hydrate the dashboard panel.",
    ],
    sortOrder: 42,
    updatedAt: null,
  },
