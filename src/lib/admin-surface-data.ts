...
const journeyProofByFeatureId: Record<string, AdminUserJourneyProof> = {
  ...
  "feature-analytics-testing": {
    status: "passed",
    lastTestedAt: "2026-05-21T20:10:00.000Z",
    environment: "Production screenshot and analytics source-data evidence.",
    method:
      "Analytics event, page-view beacon, source attribution, variant, time-window, report-export, staged notification readiness through queue-consumer readiness, and owner decision-evidence route checks.",
    summary:
    ...
    notes: [
      "Reports, report export metadata, queue readiness, and decision evidence are aggregate and public-safe; raw visitor data, queue payload bodies, message consumption, acknowledgements, retry/dead-letter rows, provider calls, and sends are not exposed or enabled.",
    ],
  },
...
const fallbackUserJourneys: AdminUserJourney[] = [
  ...
  },
  {
    ...
    featureStatus: "launch-preview",
    issueNumbers: [18, 87, 105, 107, 119, 121, 123, 125, 127, 129, 261, 263, 265, 267, 269, 271, 284, 286, 288, 290, 292, 294],
