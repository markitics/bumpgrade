...
const fallbackUserJourneys: AdminUserJourney[] = [
  ...
  },
  {
    ...
    happyPath: [
      ...
      "Read reportExports from /analytics/source-data to inspect aggregate report sections, selected fixed window, sample-size caveats, fixture cohort definitions, owner-reviewed cohort comparison evidence, and owner-reviewed alert threshold/anomaly-review evidence.",
    ...
    edgeCases: [
      "Public source-data exposes aggregate counts, aggregate source attribution counts, aggregate variant counts, fixed-window metadata, report export metadata, owner-reviewed cohort comparison evidence, owner-reviewed alert threshold/anomaly-review evidence, and conversion rows only, not raw event or assignment rows.",
      ...
      "Cookie assignment, contact-level analytics, raw referrer/query reporting, automated alert sends, experiment traffic changes, automated winners, and revenue claims remain disabled even after owner decision, cohort comparison evidence, and threshold review evidence are recorded.",
