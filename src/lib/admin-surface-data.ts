...
const journeyProofByFeatureId: Record<string, AdminUserJourneyProof> = {
  ...
  "feature-email-automation-crm": {
    status: "passed",
    lastTestedAt: "2026-05-22T14:30:00.000Z",
    environment: "Production screenshot and audience automation source-data evidence.",
    method: "Opt-in, suppression, CRM note, broadcast readiness, queue, provider, dispatch, export, and sequence delivery readiness route checks.",
    summary: "Audience capture and campaign readiness surfaces have broad screenshot proof; real provider sends and sequence delivery remain gated.",
    ciLinks: [{ label: "GitHub Actions", url: "https://github.com/markitics/bumpgrade/actions", kind: "ci" }],
    screenshotLinks: [
      ...
      { label: "Sequence delivery readiness", url: "https://bumpgrade.com/pr-screenshots/issue-351-audience-sequence-delivery-readiness.png", kind: "screenshot" },
    ],
...
const fallbackUserJourneys: AdminUserJourney[] = [
  ...
  },
  {
    ...
    happyPath: [
      ...
      "Use sequence delivery readiness records to confirm draft enrollments, paused/unsubscribed holds, sequence steps, and disabled delivery stay aggregate-only before recipient payloads, body templates, unsubscribe URLs, Queue payloads, provider IDs, or send/export URLs exist.",
