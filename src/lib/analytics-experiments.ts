...
export const analyticsDashboard: AnalyticsDashboard = {
  ...
  validation: [
    ...
    "/analytics/source-data exposes aggregate report export metadata, owner-reviewed cohort comparison evidence, owner-reviewed alert threshold/anomaly-review evidence, owner-reviewed notification delivery readiness evidence, owner-confirmed notification inbox record evidence, owner-confirmed dispatch preflight evidence, and owner-reviewed provider/domain readiness evidence without raw event rows, raw assignment rows, visitor keys, contact analytics, recipient identity, email bodies, provider message IDs, provider secrets, private DNS credentials, or queue payloads.",
