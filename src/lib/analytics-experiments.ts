...
export const analyticsDashboard: AnalyticsDashboard = {
  ...
  validation: [
    ...
    "/analytics/source-data exposes aggregate report export metadata without raw event rows, raw assignment rows, visitor keys, or contact analytics.",
