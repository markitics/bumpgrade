...
export const launchSignupPolicy: LaunchSignupPolicy = {
  ...
  payments: [
    "Free Build supports signed-in private workspace creation before payment; the anonymous playground saves structured browser-scoped launch setup before signup and can become a private launch draft plus private claim records after verified-account claim.",
