...
export const featureCatalog: FeatureRecord[] = [
  ...
  },
  {
    ...
    expectedCapabilities: [
      ...
      "Owner-session direct agent-safe private draft writes for block copy edits, resource-delivery linking, webinar-event linking, duplication, and archive/unpublish; direct agent public publishing and checkout linking remain pending in issue #417.",
    ],
    evidence: [
      "Tracked by issue #14.",
