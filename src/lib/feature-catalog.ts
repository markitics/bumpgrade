...
export const featureCatalog: FeatureRecord[] = [
  ...
  },
  {
    ...
    expectedCapabilities: [
      ...
      "Owner-session direct agent-safe private draft writes for block copy edits, duplication, and archive/unpublish; direct agent public publishing and checkout/resource/webinar linking remain pending in issue #417.",
    ],
    evidence: [
      "Tracked by issue #14.",
  ...
  },
  {
    ...
    expectedCapabilities: [
      ...
      "Owner-confirmed owner-only broadcast test sends from issue #420.",
    ...
    evidence: [
      ...
      "Issue #420 adds an owner-only broadcast test-send path with exact confirmation, idempotency, audit correlation, stale-state checks, preview/footer checks, recipient/actor hash storage, and source-data redaction before subscriber delivery exists.",
