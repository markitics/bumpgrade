...
export const featureCatalog: FeatureRecord[] = [
  ...
  },
  {
    ...
    expectedCapabilities: [
      ...
      "Owner-session direct agent-safe draft writes for block copy edits, checkout linking/unlinking, resource-delivery linking, webinar-event linking, block movement, duplication, public publishing, and archive/unpublish; direct agent block add/remove remains pending in issue #417.",
    ],
    evidence: [
      "Tracked by issue #14.",
