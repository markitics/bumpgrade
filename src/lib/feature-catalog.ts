...
export const featureCatalog: FeatureRecord[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      "Issue #466 adds logged-out structured playground save, verified account claim, and private launch draft creation while keeping go-live actions paid-gated.",
  ...
  },
  {
    ...
    expectedCapabilities: [
      ...
      "Logged-out `/playground` route with browser-scoped structured builder recovery, account claim path, and private launch draft creation after signup.",
    ...
    evidence: [
      ...
      "`/playground/source-data` exposes logged-out structured builder recovery, account claim, private draft creation, redaction, and paid go-live gates.",
    ...
    agentContract:
      "Agents may read content surface records, pricing policy records, anonymous playground records, claimed private draft boundaries, and draft resource copy, but they must distinguish browser-scoped anonymous structured saves, signed-in Free Build workspace creation, private draft creation, and paid go-live actions such as live checkout, public publishing, subscriber sends, custom domains, and fulfillment; public claims need source URLs or shipped-product evidence before publication.",
  },
];
