...
export const featureCatalog: FeatureRecord[] = [
  ...
  },
  {
    ...
    expectedCapabilities: [
      ...
      "Issue #420 keeps live delivery execution, provider calls, Queue execution, delivery results, and agent-safe write parity in one pending post-MVP bucket.",
