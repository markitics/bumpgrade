...
export const featureCatalog: FeatureRecord[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      "Issue #417 tracks advanced drag-and-drop editing, resource delivery, physical deletion policy, checkout unlinking, webinar integrations, and direct agent-safe write tools after the MVP closeout.",
    ],
    agentContract:
      "Agents may read reusable template, block-template, webinar/resource template, draft duplication, granular block-edit, block add/remove, archive/unpublish lifecycle, checkout-link, product delivery-gate, and public funnel checkout-start capability records from `/funnels/source-data`; owner sessions can seed, create from templates, duplicate, update, reorder, edit existing block title/body copy, add reusable blocks, remove safe unlinked blocks, link checkout offers, preview, publish, archive, and unpublish private draft funnel steps with confirmation where required and stale-state checks; duplicated drafts stay private and strip checkout-link metadata, block edits preserve existing block and checkout-link metadata, block removal refuses checkout-linked blocks, archived drafts preserve evidence and leave public source-data when unpublished, and published linked checkout blocks can render the sandbox checkout start surface. Issue #417 keeps direct agent writes, drag-and-drop editing, physical deletion, checkout unlinking, live webinar integrations, and private resource delivery pending until actor identity, confirmation, idempotency, stale-state checks, audit correlation, redaction, and rollback notes are designed together.",
  },
  {
