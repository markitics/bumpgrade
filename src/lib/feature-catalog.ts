...
export const featureCatalog: FeatureRecord[] = [
  ...
  },
  {
    ...
    agentContract:
      "Mobile apps can read the shared public-safe dashboard digest, render the shared owner-session plus confirmed-action requirements, and record owner-gated audit-only action intents through /api/mobile-admin/actions. Issue #414 still tracks private mobile rows, distribution, push notification, and domain-specific production confirmed-write parity work that must reuse web/admin contracts and the same audit rules as web admin actions.",
  },
  {
