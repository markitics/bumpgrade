...
export const featureCatalog: FeatureRecord[] = [
  ...
  },
  {
    ...
    expectedCapabilities: [
      ...
      "Verified publishers can create private importer subscriber records from a confirmed fresh upload or paste after preflight, without creating global audience send-list rows, sequence enrollments, sends, private exports, or go-live effects.",
