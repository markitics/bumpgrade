...
export const featureCatalog: FeatureRecord[] = [
  ...
  },
  {
    ...
    expectedCapabilities: [
      ...
      "Seeded sandbox funnel copy routing from issue #422.",
      "Issue #422 groups the remaining custom analytics schemas, holdouts, winner selection, notification execution, and direct agent-safe write parity as one post-MVP execution bucket.",
    ],
    evidence: [
      "Tracked by issue #18.",
