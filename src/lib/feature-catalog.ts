...
export const featureCatalog: FeatureRecord[] = [
  ...
  },
  {
    ...
    expectedCapabilities: [
      ...
      "Issue #422 groups live analytics automation, experiment routing, notification execution, and direct agent-safe write parity as one pending post-MVP execution bucket.",
    ],
    evidence: [
      "Tracked by issue #18.",
