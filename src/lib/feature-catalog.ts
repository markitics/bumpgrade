...
export const featureCatalog: FeatureRecord[] = [
  ...
  },
  {
    ...
    expectedCapabilities: [
      ...
      "Issue #422 groups the remaining custom analytics schemas beyond the current seeded boundary, winner selection, notification execution, and direct agent-safe write parity as one post-MVP execution bucket.",
    ],
    evidence: [
      "Tracked by issue #18.",
