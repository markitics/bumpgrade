...
export const featureCatalog: FeatureRecord[] = [
  ...
  },
  {
    ...
    expectedCapabilities: [
      ...
      "Owner-session direct agent-safe private draft writes for block copy edits, checkout linking/unlinking, resource-delivery linking, webinar-event linking, block movement, duplication, and archive/unpublish; direct agent public publishing and block add/remove remain pending in issue #417.",
    ],
    evidence: [
      "Tracked by issue #14.",
