...
export const featureCatalog: FeatureRecord[] = [
  ...
  },
  {
    ...
    issue: 467,
    summary:
      "Public import center, dedicated platform import paths, platform-specific source guides, redacted preflight review maps with export-file structure parsing, `/imports/source-data`, and verified-publisher private draft creation for moving competitor context into Bumpgrade launch workspaces.",
    ...
    expectedCapabilities: [
      ...
      "Input kinds, platform-specific source checklists, export-file analysis fields, saved private plan parts, safety gates, unsupported fields, and source evidence IDs.",
    ...
    evidence: [
      ...
      "`/imports`, dedicated importer pages, platform-specific source guides, `/imports/source-data`, public preview API routes with redacted exportFileAnalysis, private platform create routes, and private platform rollback routes listed in source-data define the importer contract slice.",
    ],
    agentContract:
      "Agents may read importer platform IDs, competitor IDs, input kinds, platform-specific source checklists, export-file analysis fields, saved private plan parts, safety gates, limitations, source IDs, routes, redacted preflight review APIs, duplicate-review statuses, verified-publisher private-draft APIs, and private rollback routes from `/imports/source-data`; agents must not claim account-to-account transfer, live payment migration, subscriber sends, customer password transfer, public publishing, or billing-impacting migration without later confirmed-write evidence.",
  },
  {
