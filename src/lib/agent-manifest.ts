...
export const agentReadContracts: AgentReadContract[] = [
  ...
  },
  {
    ...
    safeForAgents: [
      ...
      "Confirm logged-out anonymous structured playground recovery, claim-to-private-draft creation, and signed-in Free Build workspace creation are live",
      "Cite paid go-live gates for publishing, checkout, subscriber sends, domains, and fulfillment",
    ],
    writeBoundary:
      "Agents may read the pricing policy only. Saving anonymous structured playground state is browser-scoped and redacted; claim creates private launch draft work only after verified account context; creating signed-in Free Build workspaces uses authenticated account setup APIs; publishing, charging buyers, sending email, connecting domains, and fulfillment changes require paid-plan flows.",
  },
  {
    ...
    safeForAgents: [
      ...
      "Confirm claim creates private Free Build workspace and private funnel draft records",
    ...
    writeBoundary:
      "Anonymous playground writes are limited to browser-scoped structured draft launch context. Attaching a playground requires an authenticated, email-verified publisher account and creates only private Free Build workspace plus private funnel draft state.",
  },
  {
...
export const agentSourceEvidenceRoutes: AgentSourceEvidenceRoute[] = [
  ...
  },
  {
    ...
    volatileClaims:
      "Anonymous playground persistence, claim-to-private-draft creation, and signed-in Free Build workspace creation are live; paid go-live actions still require entitlement and confirmation.",
  },
  {
    id: "evidence-anonymous-playground",
    route: anonymousPlaygroundSourceDataRoute,
    resolves:
      "Browser-scoped logged-out structured playground recovery, save and claim routes, private draft creation, cookie boundaries, redaction policy, and paid go-live gates.",
    stableIds: ["anonymousPlaygroundId", "anonymousPlaygroundRoute", "anonymousPlaygroundGateId"],
    volatileClaims:
      "The playground saves structured launch context before signup and can create a private launch draft after verified-account claim; it is not public publishing, live checkout, subscriber sends, domain reservation, fulfillment, or product access.",
  },
  {
...
export const agentMcpPlan: AgentMcpPlan[] = [
  ...
  },
  {
    ...
    purpose: "Expose the logged-out structured playground recovery, claim, redaction, and go-live gate contract.",
    safetyBoundary:
