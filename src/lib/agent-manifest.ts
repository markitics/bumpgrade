...
export const agentMcpPlan: AgentMcpPlan[] = [
  ...
  },
  {
    ...
    purpose: "Expose importer platform IDs, competitor mappings, input kinds, platform-specific source checklists, export match templates, preflight signal labels, redacted sourceChecklistReview maps, exportFileAnalysis fields, platformExportMatches, private structured import-record contracts, safe extractedFields plans, private record review routes, review-action routes, extracted-field edit actions, saved private plan parts, duplicate-review statuses, rollback routes, limitations, and safety gates.",
    safetyBoundary:
