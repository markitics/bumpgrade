...
export const agentReadContracts: AgentReadContract[] = [
  ...
  },
  {
    ...
    safeForAgents: [
      ...
      "Update private draft block title/body copy, apply curated visual style presets, link checkout/resource-delivery/webinar-event metadata, move blocks, duplicate a private draft, publish a draft, or archive/unpublish a draft only after exact owner confirmation",
