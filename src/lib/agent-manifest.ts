...
export const agentSourceEvidenceRoutes: AgentSourceEvidenceRoute[] = [
  ...
  },
  {
    ...
    volatileClaims:
      "The public funnel contract exposes template and block-template records, webinar/resource page-shape records, owner-gated template-create, checkout-link, checkout-unlink, resource-delivery-link, public funnel resource delivery token, webinar-event-link, archived-draft purge, within-step block-reorder, cross-step block-move, editable draft, publish capability metadata, direct agent-safe checkout linking/unlinking, resource-delivery linking, webinar-event linking, block movement, public publishing, and archive/unpublish metadata, public sandbox checkout-start rendering metadata, entitlement-safe resource access references, external webinar registration/replay references, and aggregate owner product delivery-gate counts; it does not expose unpublished private draft copy, direct agent template creation, direct agent block add/remove, direct agent-created delivery tokens, direct agent purge, non-archived purge, unauthenticated public agent publishing, live billing, live webinar scheduling, attendance tracking, replay hosting, arbitrary uploaded private asset delivery, signed URLs, live fulfillment automation, or unconfirmed agent edits.",
  },
  {
