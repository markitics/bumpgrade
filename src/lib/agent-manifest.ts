...
export const agentReadContracts: AgentReadContract[] = [
  ...
  },
  {
    ...
    writeBoundary:
      "Anonymous playground writes are limited to browser-scoped draft launch context. Attaching a playground requires an authenticated, email-verified publisher account and creates only private Free Build workspace plus private funnel draft state.",
  },
  {
...
export const agentSourceEvidenceRoutes: AgentSourceEvidenceRoute[] = [
  ...
  },
  {
    ...
    route: anonymousPlaygroundSourceDataRoute,
    resolves:
      "Browser-scoped logged-out playground recovery, save and claim routes, private draft creation, cookie boundaries, redaction policy, and paid go-live gates.",
    stableIds: ["anonymousPlaygroundId", "anonymousPlaygroundRoute", "anonymousPlaygroundGateId"],
    volatileClaims:
      "The playground saves basic launch context before signup and can create a private launch draft after verified-account claim; it is not public publishing, live checkout, subscriber sends, domain reservation, fulfillment, or product access.",
  },
  {
