...
import {
  ...
  audienceSequenceDeliveryReceiptReadinessIssue,
...
export const agentReadContracts: AgentReadContract[] = [
  ...
  },
  {
    ...
    stableIds: [
      ...
      "sequenceDeliveryReceiptReadinessId",
      "automationRuleId",
      "broadcastDraftId",
    ...
    safeForAgents: [
      ...
      "Inspect public-safe sequence delivery-receipt readiness without processing receipts, reading webhook, polling, or receipt payloads, creating delivery receipts, provider responses, provider message IDs, delivery attempts, delivery results, recipient payloads, personalized bodies, or unsubscribe URLs",
  ...
  {
    id: "create-owner-sequence-delivery-receipt-readiness",
    title: "Owner sequence delivery-receipt readiness",
    route: audienceSequenceDeliveryReceiptReadinessApiRoute,
    kind: "api",
    auth: "owner-session",
    sourceOfTruth:
      "D1 tables audience_sequence_delivery_receipt_readiness, audience_sequence_receipt_payload_readiness, audience_sequence_provider_polling_readiness, audience_sequence_delivery_status_webhook_readiness, audience_sequence_delivery_result_readiness, audience_sequence_delivery_attempt_readiness, audience_sequence_provider_call_readiness, audience_sequence_queue_consumer_readiness, audience_sequence_enrollments, audience_subscribers, audience_consent_events, and audience_suppression_entries",
    stableIds: [
      "sequenceDeliveryReceiptReadinessId",
      "sequenceReceiptPayloadReadinessId",
      "sequenceProviderPollingReadinessId",
    ...
    safeForAgents: [
      "Inspect the owner-only sequence delivery-receipt readiness contract",
      "Create sequence delivery-receipt readiness records only with an owner session and exact confirmation",
      "Use current sequence receipt-payload readiness evidence, workspace revision, sequence status, expected readiness count, receipt, retention, redaction, retry, backpressure, audit, and idempotency checks before recording delivery-receipt readiness",
      "Confirm responses omit actor email, recipient email, recipient names, suppression hashes, delivery queue payloads, Cloudflare Queue payloads, queue payload bodies, webhook payloads, provider polling payloads, receipt payloads, delivery receipts, Queue ack/retry/dead-letter rows, delivery attempts, delivery results, webhooks, recipient payloads, personalized bodies, body templates, unsubscribe URLs, provider responses, and provider message IDs",
    ],
    writeBoundary:
      `This owner-session API records aggregate sequence delivery-receipt readiness metadata only. It does not schedule sequence steps, create delivery queue rows, make provider calls, send email, create provider responses, create provider message IDs, create delivery attempts or results, process webhooks, read or create webhook payloads, poll providers, read provider polling payloads, create provider polling results, read or create receipt payloads, create delivery receipts, enable Cloudflare Queue consumers, consume Queue messages, ack Queue messages, create retry rows, create dead-letter rows, read queue payload bodies, create queue payload bodies, create recipient payloads, create personalized bodies, expose body templates, create unsubscribe URLs, expose recipients, authorize public agent writes, or bypass future unsubscribe footer, sender-domain, suppression, provider-limit, provider-call, delivery-attempt, delivery-result, delivery-status webhook, provider-polling, receipt-payload, reconciliation, and audit requirements. Issue #${audienceSequenceDeliveryReceiptReadinessIssue} tracks this slice.`,
  },
  {
...
export const agentMcpPlan: AgentMcpPlan[] = [
  ...
  {
    id: "mcp-tool-create-sequence-delivery-receipt-readiness",
    resourceOrTool: "tool create_sequence_delivery_receipt_readiness",
    status: "planned",
    backedBy: audienceSequenceDeliveryReceiptReadinessApiRoute,
    purpose:
      `Record owner-reviewed sequence delivery-receipt readiness evidence on top of the same D1 contract from issue #${audienceSequenceDeliveryReceiptReadinessIssue}.`,
    safetyBoundary:
      "Requires owner identity, exact confirmation, idempotency key, workspace revision checks, sequence status checks, current sequence receipt-payload readiness checks, readiness-count checks, receipt, retention, redaction, retry, backpressure, audit metadata, and redacted output. It must not make provider calls, send messages, create provider responses, create provider message IDs, create delivery attempts or results, process status webhooks, read or create webhook payloads, poll providers, read provider polling payloads, create provider polling results, read or create receipt payloads, create delivery receipts, enable Queue consumers, consume or ack Queue messages, create retry/dead-letter rows, read or create queue payload bodies, create recipient payloads, create personalized bodies, expose body templates, expose unsubscribe URLs, expose raw recipient identity, or enable direct public agent writes.",
  },
  {
