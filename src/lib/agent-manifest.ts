...
export const agentReadContracts: AgentReadContract[] = [
  ...
  },
  {
    ...
    safeForAgents: [
      ...
      "Update private draft block title/body copy, link checkout/resource-delivery/webinar-event metadata, move blocks, duplicate a private draft, publish a draft, or archive/unpublish a draft only after exact owner confirmation",
    ...
    writeBoundary:
      `This owner-session API records direct agent-safe funnel draft writes after exact confirmation, idempotency, current draft revision, and audit correlation checks. It can update private draft block copy, link checkout/resource-delivery/webinar-event metadata, move blocks, duplicate a private draft, publish a draft, and archive/unpublish a draft. Publishing creates a public route mutation with archive-draft rollback and no billing mutation. It does not purge rows from an agent, create unauthenticated public agent writes, mutate billing, expose arbitrary private R2 delivery, create signed URLs, run live webinar or fulfillment automation, or expose owner identity in responses. Issue #${agentFunnelDraftWriteIssue} tracks this slice.`,
  },
  {
...
export const agentSourceEvidenceRoutes: AgentSourceEvidenceRoute[] = [
  ...
  },
  {
    ...
    volatileClaims:
      "The public funnel contract exposes template and block-template records, webinar/resource page-shape records, owner-gated template-create, checkout-link, checkout-unlink, resource-delivery-link, public funnel resource delivery token, webinar-event-link, archived-draft purge, visual block style presets, within-step block-reorder, cross-step block-move, editable draft, publish capability metadata, direct agent-safe reusable block add/remove, checkout linking/unlinking, resource-delivery linking, webinar-event linking, block movement, public publishing, and archive/unpublish metadata, public sandbox checkout-start rendering metadata, entitlement-safe resource access references, external webinar registration/replay references, and aggregate owner product delivery-gate counts; it does not expose unpublished private draft copy, direct agent template creation, direct agent-created delivery tokens, direct agent purge, direct agent visual style writes, non-archived purge, unauthenticated public agent publishing, live billing, live webinar scheduling, attendance tracking, replay hosting, arbitrary uploaded private asset delivery, signed URLs, live fulfillment automation, or unconfirmed agent edits.",
  },
  {
