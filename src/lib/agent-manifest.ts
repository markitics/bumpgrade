...
export const agentReadContracts: AgentReadContract[] = [
  ...
  },
  {
    ...
    safeForAgents: [
      ...
      "Update private draft block title/body copy, duplicate a private draft, or archive/unpublish a draft only after exact owner confirmation",
    ...
    writeBoundary:
      `This owner-session API records direct agent-safe private funnel draft writes after exact confirmation, idempotency, current draft revision, and audit correlation checks. It can update private draft block copy, duplicate a private draft, and archive/unpublish a draft. It does not publish from an agent, link checkout/resource/webinar metadata from an agent, purge rows from an agent, create unauthenticated public agent writes, mutate billing, expose arbitrary private R2 delivery, create signed URLs, run live fulfillment automation, or expose owner identity in responses. Issue #${agentFunnelDraftWriteIssue} tracks this slice.`,
  },
  {
