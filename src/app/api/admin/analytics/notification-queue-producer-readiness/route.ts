...
import {
  ...
  createAnalyticsNotificationQueueProducerReadiness,
...
type NotificationQueueProducerReadinessRequestBody = {
  dashboardId?: unknown;
  readinessId?: unknown;
  channelId?: unknown;
...
async function parseBody(request: NextRequest): Promise<NotificationQueueProducerReadinessRequestBody> {
  try {
    return (await request.json()) as NotificationQueueProducerReadinessRequestBody;
  } catch {
    return {};
  }
}
...
export async function GET(request: NextRequest) {
  ...
  const summary = await getAnalyticsNotificationQueueProducerReadinessSummary();
  ...
  return NextResponse.json({
    ...
    confirmation: { required: true, text: analyticsNotificationQueueProducerReadinessConfirmationText },
    contract: summary,
...
export async function POST(request: NextRequest) {
  ...
  const result = await createAnalyticsNotificationQueueProducerReadiness({
    ...
    notificationQueueProducerReadinessDisposition: body.notificationQueueProducerReadinessDisposition,
