...
import {
  ...
  createAnalyticsNotificationContentConsentReadiness,
...
type NotificationContentConsentReadinessRequestBody = {
  dashboardId?: unknown;
  readinessId?: unknown;
  channelId?: unknown;
...
async function parseBody(request: NextRequest): Promise<NotificationContentConsentReadinessRequestBody> {
  try {
    return (await request.json()) as NotificationContentConsentReadinessRequestBody;
  } catch {
    return {};
  }
}
...
export async function GET(request: NextRequest) {
  ...
  const summary = await getAnalyticsNotificationContentConsentReadinessSummary();
  ...
  return NextResponse.json({
    ...
    confirmation: { required: true, text: analyticsNotificationContentConsentReadinessConfirmationText },
    contract: summary,
...
export async function POST(request: NextRequest) {
  ...
  const result = await createAnalyticsNotificationContentConsentReadiness({
    ...
    notificationContentConsentReadinessDisposition: body.notificationContentConsentReadinessDisposition,
