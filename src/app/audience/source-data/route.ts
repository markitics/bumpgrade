...
import { getAudienceSequenceDeliveryReceiptReadinessSummary } from "@/lib/audience-sequence-delivery-receipt-readiness";
  ...
  return NextResponse.json({
    ...
    routes: Array.from(
      new Set([
        ...
        audienceSequenceDeliveryReceiptReadiness.apiRoute,
