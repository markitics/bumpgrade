    ...
    <main className="route-page">
      ...
      <section className="feature-hero">
        ...
        <aside className="feature-status-panel" aria-label="Affiliate preview status">
          ...
          <span>
            Draft preview only. Referral links, attribution rules, commission ledger fixtures, and payout review states
            are public-safe records; live clicks, cookies, buyers, tax forms, and payout accounts stay disabled.
          </span>
        </aside>
      </section>
      ...
      <section className="content-band alternate">
        <div className="feature-section-heading">
          <div>
            ...
            <h2>Partner links resolve to stable draft attribution rules</h2>
          </div>
      ...
      <section className="content-band dark-band">
        <div className="feature-section-heading">
          <div>
            ...
            <h2>Agents can inspect partner fixtures, not create payable commissions.</h2>
          </div>
        ...
        <div className="feature-proof-grid">
          <div>
            ...
            <p>
              <code>/affiliates/source-data</code> exposes public-safe partners, links, rules, ledger fixtures, payout
              batches, review flags, and audit events.
            </p>
          </div>
          <div>
            <BadgeDollarSign aria-hidden="true" />
